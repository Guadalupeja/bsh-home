...
@section('title', 'Bombas circuladoras bajo consumo energético NCE EI - CALPEDA')
@section('description', 'Bombas circuladoras bajo consumo energético NCE EI - CALPEDA. Entrega Inmediata. 
Distribuidor Mayorista Mx. Mejor precio. Refacciones y Mtto. Marca Italiana.')
<style>
    .swiper-container {
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "NCE EI Bombas circuladoras de bajo consumo",
      "description": "La bomba circuladora NCE EI de Calpeda está diseñada para sistemas de calefacción y aire acondicionado, ofreciendo un control preciso del flujo de agua con alta eficiencia energética.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda",
        "logo": "/img/logo-calpeda.png"
      },
      "sku": "NCE-EI-002",
      "mpn": "NCE-EI-002",
      "category": "Centrifugal Pumps",
      "image": [
        "/img/Bombas-circulares-gemelas-de-ahorro-energetico-con-bridas-NCED-EI.png.webp"
      ],
      "offers": {
        "@type": "Offer",
      ...
      "review": [
        {
          ...
          "reviewBody": "La bomba NCE EI es increíblemente eficiente, con un ahorro de energía notable."
        },
        {
          "@type": "Review",
          "reviewRating": {
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La bomba circuladora NCE EI de Calpeda es un equipo de bajo consumo diseñado para optimizar el flujo de agua en sistemas de calefacción y aire acondicionado."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Cuenta con un motor síncrono de imán permanente y un inversor incorporado para controlar la velocidad."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Puedes adquirirla contactando a nuestras sucursales en México para el mejor precio y soporte especializado."
          }
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "serviceType": "Venta, instalación y mantenimiento de bombas circuladoras NCE EI",
      "provider": {
        "@type": "Organization",
        "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)",
        "contactPoint": {
      ...
      "description": "Ofrecemos venta, instalación y mantenimiento especializado de bombas circuladoras NCE EI, con soporte técnico experto en México."
    }
    </script>
                                    ...
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        <div class="swiper-container">
                                            <figure class="m-0 block box-border leading-[27px]">
                                                <picture decoding="async" title="NCE EI - Bombas circuladoras de bajo consumo 21" class="box-border">
                                                    <source type="image/webp" srcset="/img/NCE_EI_web_1920-jpg-wpcf_1024x1024.jpg" />
                                                    <img decoding="async" src="/img/NCE_EI_web_1920-jpg-wpcf_1024x1024.jpg" alt="NCE-EI-Bombas-circuladoras-de-bajo-consumo" class="max-w-[300px] mt-5 h-auto align-middle border-none" />
                                                </picture>
                                            </figure>
                                        </div>
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    ...
                                                    <p class="text-[#666] leading-[27px] mb-8 mt-0">
                                                        Bomba de circulación de velocidad variable con ahorro de energía accionada por un motor síncrono de imán permanente (pm) controlado por un inversor incorporado
                                                    </p>
                                                    <p class="text-[#666] leading-[27px] mb-8 mt-0 font-bold">Aplicaciones</p>
                                                    <p class="text-[#666] leading-[27px] mb-8 mt-0">
                                                        – Sistemas de calefacción doméstica.<br />
                                                        – Módulos para la calefacción por suelo radiante.<br />
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas circuladoras de bajo consumo.                                            </div>
                                        </div>
                                    </h1>
                                </div>
                            </div>
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    ...
                                    <div class="relative w-full flex justify-center">
                                        <div class="transition-all duration-300 ease-in-out transform">
                                            ...
                                            <img fetchpriority="high" decoding="async" width="1024" height="854" src="/img/NCE_EI_curve-1-1024x854.png" alt="NCE EI curve 1" srcset="/img/NCE_EI_curve-1-1024x854.png 1024w, /img/NCE_EI_curve-1-300x250.png 300w, /img/NCE_EI_curve-1-768x641.png 768w, /img/NCE_EI_curve-1-600x500.png 600w, /img/NCE_EI_curve-1.png 1097w" sizes="(max-width: 1024px) 100vw, 1024px" title="NCE EI - Bombas circuladoras de bajo consumo 22" class="max-w-full h-auto align-middle border-none" />
                                        </a>                                           
                                        </div>
                                    </div>
                                </div>
