...
@section('title', 'Bombas sumergibles para manejo de agua sucia | Calpeda GQR')
@section('description', 'Cotiza bomba sumergible GQR para aguas con sólidos y lodos de cárcamos y cisternas. 
Acero inoxidable, fundición y plástico. Entrega inmediata Precio Mayorista')
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bomba Sumergible para manejo de agua sucia | Calpeda GQR",
      "description": "Cotiza bomba sumergible GQR para aguas con sólidos y lodos de cárcamos y cisternas. Acero inoxidable, fundición y plástico. Entrega inmediata Precio Mayorista.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      "offers": {
        "@type": "AggregateOffer",
        "url": "https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-drenaje-y-tratamiento-de-aguas/bomba-sumergible-para-achiques-gqr/",
        "priceCurrency": "MXN",
        "lowPrice": "10000",
        "highPrice": "55000",
        "offerCount": "5",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 6,
          "name": "Bomba Sumergible para manejo de agua sucia | Calpeda GQR",
          "item": "https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bomba-sumergible-para-achiques-gqr/"
        }
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Cuáles son las aplicaciones de la bomba sumergible GQR?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La bomba sumergible GQR es ideal para el manejo de agua con sólidos y lodos en cárcamos y cisternas, fabricada en acero inoxidable, fundición y plástico para una mayor durabilidad."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cómo puedo solicitar más información sobre la bomba GQR?",
          "acceptedAnswer": {
            "@type": "Answer",
                        ...
                        <div class="relative z-20 box-border">
                            <div class="bg-transparent box-border">
                                <ul class="bg-transparent m-0 p-0 inline-flex list-none flex-wrap rounded-lg box-border">
                                    ...
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto">Bomba sumergible para achiques – GQR</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div aria-live="off" class="box-border transform translate-x-0 relative w-full h-[489.047px] z-[1] flex transition-transform">
                                                            <div role="group" aria-roledescription="slide" aria-label="1 de 1" class="box-border flex-shrink-0 w-full h-[489.047px] relative max-w-full text-center">
                                                                <figure class="m-0 block box-border leading-[23px]">
                                                                    <picture decoding="async" title="Bomba Sumergible GQR. Bombas sumergibles para agua sucia y lodos." class="box-border">
                                                                        <source type="image/webp" srcset="/img/Bomba-sumergible-para-achiques-GQR.png.webp" />
                                                                        <img alt="Bombas Calpeda sumergibles GQR​" src="/img/Bomba-sumergible-para-achiques-GQR.png.webp" decoding="async" class="max-w-full h-auto align-middle border-none box-border shadow-none" />
                                                                    </picture>
                                                                </figure>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="leading-[23px] mb-[32px] mt-0 box-border text-[#666666]">
                                                        Bomba sumergible para manejo de agua con sólidos en inmersión de hasta 10 mm, con impulsor abierto y descarga vertical.
                                                     </p>
                                                    
                                                     <ul class="list-disc pl-4">
                                                        <li>Cuerpo de bomba e impulsor en fundición gris.</li>
                                                        <li>Camisa, cuerpo y eje en Acero Inoxidable AISI 304.</li>
                                                        ...
                                                        <li>Motores trifásicos 230/440 V y monofásico 230V.</li>
                                                        <li>Profundidad de inmersión de hasta 5 metros y mínima de 200 mm.</li>
                                                        <li>Incluye cable de 10 metros.</li>
                                                        <li>Boca de inmersión roscada de ½” o bien bridada, a petición.</li>
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas sumergibles para agua sucia y lodos.</div>
                                        </div>
                                    </h1>
                                    <p class="leading-[23px] mb-[32px] mt-2 text-justify text-[#666666] box-border">
                                        Bomba sumergible monorodete de acero inoxidable al níquel-cromo, con boca de impulsión vertical.
                                        <span class="box-border">GXR</span>: con rodete abierto.
                                        <span class="box-border">GXV</span>: con rodete tipo vortex.
                                      </p>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:mt-[325px] my-[45px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    <div class="box-border text-center relative w-full flex flex-row flex-nowrap justify-normal items-normal">
                                        <div class="box-border transition-all duration-300">
                                            <a href="/img/curve_GQR.jpg.webp" 
                                               data-elementor-open-lightbox="yes" 
                                               data-elementor-lightbox-title="curve_GQR" 
                                               data-elementor-lightbox-description="Rango operativo bomba sumergible GQR" 
                                               ...
                                               class="text-blue-600 no-underline bg-transparent inline-block box-shadow-none">
                                                <picture fetchpriority="high" decoding="async" title="Bomba sumergible para achiques - GQR 2" class="box-border">
                                                    <source type="image/webp" sizes="(max-width: 941px) 100vw, 941px" srcset="/img/curve_GQR.jpg.webp 941w, /img/curve_GQR-300x173.jpg.webp 300w, /img/curve_GQR-768x442.jpg.webp 768w" />
                                                    <img fetchpriority="high" width="941" height="542" alt="Rango operativo bomba sumergible GQR" sizes="(max-width: 941px) 100vw, 941px" src="/img/curve_GQR.jpg" class="max-w-full h-auto align-middle border-none inline-block box-shadow-none" />
                                                </picture>
                                            </a>
                                        </div>
                                    </div>
