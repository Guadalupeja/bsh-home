                            ...
                            <div class="w-full">
                                <div class="transition-all duration-300">
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        <div class="box-border p-2.5 flex relative w-full flex-col lg:flex-wrap content-start">
                                            <div class="relative w-full flex-nowrap">
                                                <div class="transition-all duration-300">
                                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                                        <div aria-live="off" class="content-box relative w-full h-[489.047px] z-1 flex transition-transform">
                                                            <div role="group" aria-roledescription="slide" aria-label="1 de 1" class="flex-shrink-0 w-full h-[489.047px] relative max-w-full text-center">
                                                                <figure class="m-0 block box-border leading-[27px]">
                                                                    <picture decoding="async" title="T, TP Bombas con rodete periférico 7" class="box-border">
                                                                        <source type="image/webp" srcset="/img/Bombas-con-rodete-periferico-T-TP.png.webp" class="box-border" />
                                                                        <img decoding="async" src="/img/Bombas-con-rodete-periferico-T-TP.png" alt="Bombas-con-rodete-periferico---T-TP" class="max-w-full h-auto align-middle border-none box-border" />
                                                                    </picture>
                                                                </figure>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    ...
                                                    <ul class="list-disc pl-4">
                                                        ...
                                                        <li>Eje de Acero inoxidable Cr-Ni/ Cr-Ni-Mo..</li>
                                                        <li>Qmax. 6 m3/h.</li>
                                                        <li>Hmax. 165 m.</li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div data-id="06896a4" data-element_type="widget" data-settings='{"youtube_url":"https://www.youtube.com/watch?v=sjQzpHTaGXo","video_type":"youtube","controls":"yes"}' data-widget_type="video.default" class="box-border mb-5 relative w-full flex-row flex-nowrap">
                                                <div class="box-border overflow-hidden transition-all duration-300 ease-in-out">
                                                    <div class="box-border aspect-w-16 aspect-h-9">
                                                        <iframe frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" title="Come montare pompe periferiche T / How to assemble T speripheral pump" width="640" height="360" src="https://www.youtube.com/embed/sjQzpHTaGXo?controls=1&rel=0&playsinline=0&modestbranding=0&autoplay=0&enablejsapi=1&origin=https%3A%2F%2Fbombasellos.com.mx&widgetid=1" class="w-full h-[379.328px] flex bg-black max-w-full m-0 leading-[15px]"></iframe>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:my-[315px] my-[45px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    <div data-id="b9d3ab5" data-element_type="widget" data-widget_type="video.default" class="box-border relative w-full flex-row flex-nowrap">
                                        <div class="box-border overflow-hidden transition-all duration-300 ease-in-out">
                                            <div class="box-border aspect-w-16 aspect-h-9">
                                                <iframe frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" title="Come smontare pompe periferiche T / How to disassemble T speripheral pump" width="640" height="360" src="https://www.youtube.com/embed/RSF4wQI5dY8?controls=1&rel=0&playsinline=0&modestbranding=0&autoplay=0&enablejsapi=1&origin=https%3A%2F%2Fbombasellos.com.mx&widgetid=3" class="w-full h-[379.328px] flex bg-black max-w-full m-0 leading-[15px]"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
