...
@section('title', 'Bombas verticales de acoplamiento corto | MPSU CALPEDA.')
@section('description', '
Cotiza aquí Bombas verticales de acoplamiento corto MPSU CALPEDA Entrega Inmediata. 
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Bombas verticales de acoplamiento corto MPSU CALPEDA",
  "description": "Cotiza aquí Bombas verticales de acoplamiento corto MPSU CALPEDA. Entrega Inmediata. Marca Premium Italiana. Distribuidor Mayorista. Refacciones y Mantenimiento.",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
  ...
  "image": [
    "/img/Bombas-verticales-de-acoplamiento-corto-de-etapas-multiples-MPUS.png.webp",
    "/img/MPSU_curve.png.webp"
  ],
  "offers": {
    "@type": "Offer",
  ...
  "review": [
    {
      ...
      "reviewBody": "Producto de excelente calidad, perfecto para aplicaciones industriales y muy confiable."
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "Fácil de instalar y mantener, aunque requiere cierta experiencia técnica."
    }
  ],
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://bombasellos.com.mx/bombas-verticales-de-acoplamiento-corto-mpsu-calpeda"
  }
}
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Bombas verticales de acoplamiento corto MPSU CALPEDA",
      "item": "https://bombasellos.com.mx/bombas-verticales-de-acoplamiento-corto-mpsu-calpeda"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué son las bombas verticales de acoplamiento corto MPSU CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las bombas verticales de acoplamiento corto MPSU CALPEDA están diseñadas para manejar agua limpia en aplicaciones industriales, civiles y domésticas. Son ideales para sistemas de presurización, drenaje, y sistemas de climatización."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cuál es el precio de las bombas MPSU CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "El precio de las bombas MPSU CALPEDA varía según el modelo y las especificaciones. Para más detalles, visita nuestro sitio web o contacta con nuestro equipo de ventas."
      }
    },
    {
      "@type": "Question",
      "name": "¿Dónde puedo comprar bombas MPSU CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Puedes comprar bombas MPSU CALPEDA a través de nuestro sitio web o visitando nuestras sucursales. Ofrecemos entrega inmediata y soporte técnico especializado."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Service",
  "serviceType": "Venta y mantenimiento de bombas verticales de acoplamiento corto",
  "provider": {
    "@type": "Organization",
    "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)"
  },
  "description": "Ofrecemos venta, instalación y mantenimiento especializado de bombas verticales de acoplamiento corto MPSU CALPEDA. Distribuidor mayorista en México con soporte técnico experto."
}
</script>
@endsection
                            ...
                            <div class="w-full">
                                <div class="transition-all duration-300">
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        <img 
                                            decoding="async" 
                                            src="/img/Bombas-verticales-de-acoplamiento-corto-de-etapas-multiples-MPUS.png.webp" 
                                            alt="MPSU-Bombas verticales de acoplamiento corto de etapas múltiples" 
                                            class="max-w-full h-auto align-middle border-0 border-none rounded-none shadow-none box-border"
                                        />
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                <p class="text-[#666666] leading-[27px] mt-0 mb-[32px]">
                                                    <strong class="font-semibold">Construcción:</strong> <br><br> Bombas sumergibles o de superficie verticales de acoplamiento múltiple de etapas múltiples de 5”. Cubierta externa en acero inoxidable <span class="font-semibold">AISI</span> 304 y etapas Noryl. <span class="font-semibold">MPSUM</span> con condensador incorporado, accesible a través de la carcasa de entrega. Conexión de succión en la carcasa inferior y conexión de entrega en la carcasa superior. Motor enfriado por el agua bombeada que pasa entre la cubierta del motor y la cubierta externa. Doble sello mecánico del eje con cámara de aceite interpuesta.
                                                </p>
                                                <p class="text-[#666666] leading-[27px] mt-0 mb-[32px]">
                                                    <strong class="font-semibold">Solicitud:</strong>
                                                </p>
                                                <p class="text-[#666666] leading-[27px] mt-0 mb-[32px]">
                                                    – Para agua limpia sin abrasivos o aditivos agresivos para los materiales de la bomba.<br>
                                                    – Para aplicaciones domésticas, civiles e industriales.<br>
                                                    – Para instalación en espacios confinados con mínima ventilación.<br>
                                                    – Para instalación en lugares sujetos a riesgo de inundación temporal, la bomba puede estar completamente sumergida.<br>
                                                    – Para la instalación en áreas expuestas al chorro de agua.<br>
                                                    – Cuando se requiere una operación de bajo ruido.
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas verticales de acoplamiento corto de etapas múltiples
                                            </div>
                                        </div>
                                    </h1>
                                </div>
                                            ...
                                            <div class="box-border w-full relative flex min-h-[1px] flex-wrap content-start">
                                                <div class="box-border p-2.5 w-full flex relative flex-wrap content-start">
                                                    <div class="box-border text-center w-full flex flex-col items-center justify-center">
                                                        <div class="transition-all duration-300">
                                                                    <picture decoding="async" title="Bombas verticales de acoplamiento MPSU CURVE" class="box-border">
                                                                    <source type="image/webp" srcset="/img/MPSU_curve.png.webp 1024w, /img/MPSU_curve.png.webp 300w, /img/MPSU_curve.png.webp 768w, /img/MPSU_curve.png.webp 1176w" sizes="(max-width: 1024px) 100vw, 1024px" class="box-border" />
                                                                    <img decoding="async" width="1024" height="437" src="/img/MPSU_curve.png.webp" alt="curve MPSU" class="max-w-full h-auto align-middle border-none box-border inline-block shadow-none" />
                                                                </picture>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="box-border text-gray-600 font-roboto font-normal text-left w-full flex flex-row flex-nowrap">
                                                        <div class="transition-all duration-300">
                                                            <p class="text-gray-600 leading-7 mb-8 mt-0">
                                                                <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/ES%20-%20Espa%C3%B1ol/DIVISI/MPSU_ES.pdf" target="_blank" rel="noopener" class="text-blue-600 no-underline box-shadow-none">Descarga<br />Catalogo 50 Hz</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="box-border w-1/2 relative flex min-h-[1px] flex-wrap content-start">
                                                <div class="box-border p-2.5 w-full flex relative flex-wrap content-start">
                                                    <div class="box-border text-gray-600 font-roboto font-normal text-left w-full flex flex-row flex-nowrap">
                                                        <div class="transition-all duration-300">
                                                            <p class="text-gray-600 leading-7 mb-8 mt-0">
                                                                <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/MPSU_60Hz2023.pdf" target="_blank" rel="noopener" class="text-blue-600 no-underline box-shadow-none">Descarga<br />Catalogo 60 Hz</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="box-border w-1/2 relative flex min-h-[1px] flex-wrap content-start">
                                                <div class="box-border p-2.5 w-full flex relative flex-wrap content-start">
                                                    <div class="box-border text-gray-600 font-roboto font-normal text-left w-full flex flex-row flex-nowrap">
                                                        <div class="transition-all duration-300">
                                                            <p class="text-gray-600 leading-7 mb-8 mt-0">
                                                                <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/ISTRUZIONI/IST%20MPSU_2018%20Rev1_.pdf" target="_blank" rel="noopener" class="text-blue-600 no-underline box-shadow-none">Instrucciones</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
