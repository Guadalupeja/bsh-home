...
@section('title', 'Bombas centrífugas autoaspirantes monobloc jet | CALPEDA NGL')
@section('description', 'Bombas centrífugas autoaspirantes monobloc jet NGL Calpeda. Entrega Inmediata. 
Marca Premium Italiana. Distribuidor Mayorista Mx. Refacciones y Mantenimiento')
<style>
    .swiper-container {
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bomba centrífuga autoaspirante monobloc | Calpeda NGL",
      "description": "Bomba centrífuga autoaspirante monobloc jet NGL de Calpeda, ideal para suministro de agua y aplicaciones industriales. Disponibilidad inmediata y soporte técnico especializado.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      ...
      "image": [
        "/img/NGL-Bombas-autoaspirantes-jet-1.png.webp",
        "/img/NGL-Bombas-autoaspirantes-jet-2.png.webp",
        "/img/curve_NGL-1024x555.png"
      ],
      "offers": {
        "@type": "Offer",
        "url": "https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-calpeda-obra-civil/",
        "priceCurrency": "MXN",
        "price": "25000",
      ...
      "review": [
        {
          ...
          "reviewBody": "Excelente rendimiento en aplicaciones de suministro de agua. Muy confiable."
        },
        {
          "@type": "Review",
          "reviewRating": {
          ...
          "reviewBody": "Buena calidad, aunque el precio es un poco alto."
        }
      ],
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://bombasellos.com.mx/bombas-centrifugas-autoaspirantes-monobloc-jet"
      }
    }
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Bombas Calpeda – Obra Civil",
      "item": "https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-calpeda-obra-civil/"
    },
    {
      "@type": "ListItem",
      "position": 5,
      "name": "Bombas centrífugas autoaspirantes monobloc jet – NGL",
      "item": "https://bombasellos.com.mx/bombas-centrifugas-autoaspirantes-monobloc-jet"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué aplicaciones tiene la bomba NGL de Calpeda?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "La bomba NGL de Calpeda es ideal para suministro de agua, bombeo de agua con aire o gases, y aumento de presión en redes de distribución."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cuáles son las características principales de la bomba NGL?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "La bomba NGL es una centrífuga autoaspirante monobloc con inyector incorporado, diseñada para aplicaciones que requieren confiabilidad y eficiencia."
      }
    },
    {
      "@type": "Question",
      "name": "¿Dónde puedo comprar la bomba NGL de Calpeda?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Puedes comprar la bomba NGL a través de nuestro sitio web o en nuestras sucursales. Ofrecemos soporte técnico y servicio postventa."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "description": "Distribución y mantenimiento especializado de bombas industriales Calpeda, incluyendo bombas centrífugas autoaspirantes NGL."
}
</script>
@endsection
                ...
                <div class="max-w-[1190px] mx-auto flex flex-col lg:flex-row">
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/NGL-Bombas-autoaspirantes-jet-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/NGL-Bombas-autoaspirantes-jet-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                            </div>
                                            <!-- Add Pagination -->
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-[#666] leading-[27px] mb-8 mt-0 font-bold">Ejecución</p>
                                                    <p class="text-[#666] leading-[27px] mb-8 mt-0">Bomba centrífuga autoaspirante monobloc con inyector incorporado.</p>
                                                    <p class="text-[#666] leading-[27px] mb-8 mt-0 font-bold">Aplicaciones</p>
                                                    <p class="text-[#666] leading-[27px] mb-8 mt-0">– Para suministro de agua con aspiración de pozo.- Para bombear agua que contiene aire u otras sustancias gaseosas.- Para aumentar la presión del agua que llega directamente a la bomba.- Para aumentar la presión disponible de una red de distribución (observar las disposiciones locales).- Para el jardín.- Para lavar con chorro de agua a presión.</p>
                    ...
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex flex-wrap content-start">
                        <div class="relative w-full">
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">NGL</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas autoaspirantes jet
                                            </div>
                                        </div>
                                    </h1>
                                </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none mt-[130px]  lg:my-[180px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                  <section data-id="e2302cd" class="w-full relative">
                                    <div class="max-w-[1190px] mx-auto flex relative">
                                        <div data-id="5e55c22" class="w-full relative flex">
                                            <div class="w-full p-2.5 flex flex-wrap relative">
                                                <div data-id="e69dbac" class="w-full mb-5 text-[#7a7a7a] font-roboto font-normal text-[12px] relative flex">
                                                    <div class="transition-all duration-300 ease-in-out">
                                                        <p class="text-[#666] leading-[21.6px] mb-8 mt-0 font-bold">Campo de aplicaciones</p>
                                                    </div>
                                                </div>
                                                <div data-id="ada5c6c" class="w-full text-center relative flex">
                                                    <div class="transition-all duration-300 ease-in-out">
                                                        <img decoding="async" width="1024" height="555" src="/img/curve_NGL-1024x555.png" alt="curve NGL" class="max-w-full h-auto align-middle border-none inline-block">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/ES%20-%20Espa%C3%B1ol/DIVISI/NGL_ES.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar<br />Catálogo 50 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/NGL_60Hz2023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Catálogo<br/>60 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/ISTRUZIONI/IST%20NG_NGX_NGL%20REV7%2005_2021.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">
