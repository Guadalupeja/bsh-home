                ...
                <div class="bg-transparent mb-0 box-border">
                    <div class="box-border">
                        <ul class="bg-transparent m-0 p-0 inline-flex mb-0 list-none flex-wrap rounded-lg mt-0 box-border">
                            ...
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto">
                                Bombas de alimentación a chillers – Circuitos HVAC | Calpeda
                            </li>
                        </ul>                        
                    </div>
                </div>
        ...
        <div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
            ...
            <div class="mb-2 relative w-full flex flex-row">
                <div class="box-border transition-all ease-in-out">
                    <div>
                        <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                            <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-recirculacion-y-climatizacion/bombas-in-line-n-2900-1-min-n-1450-1-min-nr-nr4') }}" class="text-[#007bff] no-underline bg-transparent shadow-none">
        ...
        <div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
            ...
            <div class="mb-2 relative w-full flex flex-row">
                <div class="box-border transition-all ease-in-out">
                    <div>
                        <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                            <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-mxh') }}" class="text-[#007bff] no-underline bg-transparent shadow-none">
