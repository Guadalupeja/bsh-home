...
@section('title', 'Bombas de alimentación a chillers - Circuitos HVAC | Calpeda')
@section('description', '	
Bombas Centrifugas Calpeda® alimentación a circuitos HVAC. Entrega Inmediata. 
                ...
                <div class="bg-transparent mb-0 box-border">
                    <div class="box-border">
                        <ul class="bg-transparent m-0 p-0 inline-flex mb-0 list-none flex-wrap rounded-lg mt-0 box-border">
                            ...
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto"><span class="text-[#043e81] px-1">/</span></li>
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto">Bombas de alimentación a chillers – Circuitos HVAC | Calpeda</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <h1 class="text-[35px] leading-[44.5455px] mt-0 mb-0 font-semibold text-[#666666] font-['Open Sans'] box-border m-0 text-left break-all relative">
                <div class="inline-block relative z-10">
                    <div class="font-roboto font-semibold text-[#043e81] border-none text-[27px] inline-flex border-solid border-[#6ec1e4]">
                        Bombas de recirculación y alimentación de circuitos HVAC.
                    </div>
    ...
    <div class="w-full lg:w-3/4 flex flex-wrap px-1 py-0 mx-auto">
        ...
        <div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <picture loading="lazy" decoding="async" title="Bombas Calpeda - Bombas de alimentación a circuitos HVAC en la industria. 3" class="box-border">
                            <source type="image/webp" srcset="/img/Bombas-centriIfugas-monobloc-n-1450-1min-NM4-NMS4-1.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                    ...
                    <div>
                        <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                            <a href="https://bombasellos.com.mx:/bombas-calpeda-recirculacion-y-climatizacion/bombas-centrifugas-monobloc-n-%e2%89%88-1450-1-min-nm4-nms4/" class="text-[#007bff] no-underline bg-transparent">
                                <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bomba NM4</span>
                            </a>
                        </h2>
                    </div>
                </div>
        ...
        <div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <picture loading="lazy" decoding="async" title="Bombas Calpeda - Bombas de alimentación a circuitos HVAC en la industria. 5" class="box-border">
            ...
            <div class="mb-2 relative w-full flex flex-row">
                <div class="box-border transition-all ease-in-out">
                    <div>
                        <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                            <a href="https://bombasellos.com.mx:/bombas-calpeda-recirculacion-y-climatizacion/bombas-in-line-n-2900-1-min-n-1450-1-min-nr-nr4/" class="text-[#007bff] no-underline bg-transparent shadow-none">
 ...
 <div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
    ...
    <div class="mb-2 relative w-full flex flex-row">
        <div class="box-border transition-all ease-in-out">
            <div>
                <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                    <a href="https://bombasellos.com.mx:/bombas-calpeda-recirculacion-y-climatizacion/bombas-circulantes-de-tres-velocidades-con-puertos-roscados-nc3/" class="text-[#007bff] no-underline bg-transparent">
