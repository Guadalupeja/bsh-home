...
@section('title', 'T, TP Bombas con rodete periférico centrifugas | Calpeda')
@section('description', 'Bombas T, TP con rodete periférico CALPEDA. Entrega Inmediata. 
Marca Premium Italiana. Distribuidor Mayorista MX. Refacciones y Mantenimiento, mejor precio.')
<style>
    .swiper-container {
      width: 320px; /* Define the width of the carousel */
      height: 320px; /* Define la altura del carousel */
    }
</style>
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "T, TP Bombas con rodete periférico - Calpeda®",
  "description": "Bombas Centrifugas Calpeda® T, TP con rodete periférico. Disponibles con entrega inmediata, fabricadas por la marca premium italiana Calpeda. Ofrecemos distribución mayorista, así como refacciones y mantenimiento.",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "T, TP Bombas con rodete periférico",
      "item": "https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/t-tp-bombas-con-rodete-periferico/"
    }
  ]
}
</script>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ofrecemos bombas monobloc con impulsor periférico en hierro o bronce, diseñadas para aumentar la presión en redes de agua, circuitos HVAC y alimentación a calderas."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cómo puedo solicitar más información sobre las bombas Calpeda T, TP?",
      "acceptedAnswer": {
        "@type": "Answer",
                ...
                <div class="max-w-[1190px] mx-auto flex flex-col lg:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <div class="transition-all duration-300">
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[90px]">
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-[#666] leading-[23px] mb-[32px] mt-0 box-border font-bold">Ejecución</p>
                                                <p class="text-[#666] leading-[23px] mb-[32px] mt-0 box-border">
                                                    Electrobomba monobloc con rodete periférico.<br />
                                                    T, TP: Ejecución con cuerpo bomba y acoplamiento en hierro.<br />
                                                    B-T, B-TP: Ejecución con cuerpo bomba y acoplamiento en bronce. Las bombas en bronce se suministran totalmente pintadas.
                                                </p>
                                                <p class="text-[#666] leading-[23px] mb-[32px] mt-0 box-border font-bold">Aplicaciones</p>
                                                <p class="text-[#666] leading-[23px] mb-[32px] mt-0 box-border">
                                                    – Para líquidos limpios, sin partículas sólidas en suspensión, y no agresivos para los materiales de la bomba.<br />
                                                    – Para aumentar la presión disponible en una red de distribución de agua (observar las disposiciones locales).<br />
                                                    – Por sus reducidas dimensiones son muy adecuadas para el montaje en máquinas y sistemas de refrigeración, circuitos de alimentación, alimentación de calderas, etc.
                                                </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div data-id="06896a4" data-element_type="widget" data-settings='{"youtube_url":"https://www.youtube.com/watch?v=sjQzpHTaGXo","video_type":"youtube","controls":"yes"}' data-widget_type="video.default" class="box-border mb-5 relative w-full flex-row flex-nowrap">
                                                <div class="box-border overflow-hidden transition-all duration-300 ease-in-out">
                                                    <div class="box-border aspect-w-16 aspect-h-9">
                                                        <iframe width="674" height="379" src="https://www.youtube.com/embed/sjQzpHTaGXo" title="Come montare pompe periferiche T / How to assemble T speripheral pump" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                            <div data-id="06896a4" data-element_type="widget" data-settings='{"youtube_url":"https://www.youtube.com/watch?v=sjQzpHTaGXo","video_type":"youtube","controls":"yes"}' data-widget_type="video.default" class="box-border mb-5 relative w-full flex-row flex-nowrap">
                                                <div class="box-border overflow-hidden transition-all duration-300 ease-in-out">
                                                    <div class="box-border aspect-w-16 aspect-h-9">
                                                        <iframe width="674" height="379" src="https://www.youtube.com/embed/RSF4wQI5dY8" title="Come smontare pompe periferiche T / How to disassemble T speripheral pump" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex flex-col lg:flex-wrap content-start">
                        <div class="relative w-full">
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">T, TP</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas con rodete periférico</div>
                                        </div>
                                    </h1>
                                </div>
                            </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:my-[315px] my-[45px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                        ...
                                        <div data-id="5e55c22" data-element_type="column" class="w-full box-border relative min-h-[1px] flex flex-wrap-none justify-normal items-normal content-normal">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="7ce4ff1" data-element_type="widget" data-widget_type="image.default" class="box-border text-center relative w-full flex-wrap-none justify-normal items-normal content-normal">
                                                    <div class="box-border transition-all duration-300 ease-in-out transform">
                                                        <img fetchpriority="high" decoding="async" width="994" height="591" src="/img/curve_T-TP-1.jpg.webp" alt="curve T TP 1" 
                                                        srcset="/img/curve_T-TP-1.jpg.webp 994w, 
                                                                /img/curve_T-TP-1.jpg.webp 300w, 
                                                                /img/curve_T-TP-1.jpg.webp 768w, 
                                                                /img/curve_T-TP-1-600x357.jpg.webp 600w" 
                                                ...
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/ES%20-%20Espa%C3%B1ol/DIVISI/T%2C%20TP_ES.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Catálogo<br/>50 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/T%2C%20TP_60Hz2023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Catálogo<br/>60 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/ISTRUZIONI/IST%20CT%2CT%2C%20TP%2C_Rev25_03_2020.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">
