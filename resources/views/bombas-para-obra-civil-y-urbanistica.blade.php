...
@section('title', 'Bombas para obra civil - Tratamiento de aguas, recirculación')
@section('description', '
Cotiza aquí Bombas para obra civil: servicios generales. 
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bombas para obra civil - Tratamiento de aguas, recirculación",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      "description": "Bombas para obra civil: servicios de manejo de agua limpia, recirculación, presurización de sistemas de aire acondicionado, y sistemas contra incendio. Entrega inmediata, marca premium italiana, distribuidor mayorista, refacciones y mantenimiento.",
      "sku": "BOM-OBRA-CIVIL",
      "mpn": "CALPEDA-123456",
      "category": "Industrial Pumps",
      "image": [
        "https://bombasellos.com.mx/img/Bombas-para-obra-civil-y-urbanistica.png.webp"
      ],
      "offers": {
        "@type": "Offer",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://bombasellos.com.mx/bombas-para-obra-civil"
      }
    }
    </script>
    @endsection
                ...
                <div class="mb-5">
                    <h1 class="text-[35px] leading-[44.5455px] font-semibold text-[#343434]">
                        <span class="inline-block relative z-10">
                            <span class="inline-flex font-black text-[#043e81]">Bombas para obra civil</span>
                        </span>
                    </h1>
                </div>
                <div class="mb-5 text-[#666]">
                    <p class="leading-[23px] mb-8 text-justify">
                        Toda la gama de producto enfocada en la edificación comercial. Servicios de manejo de agua limpia; recirculadores, presurización de sistemas de aire acondicionado y sistemas contra incendio. Manejo de aguas residuales y tratadas con contenido de sólidos.
                        <br>
                        <br>
        ...
        <div class="w-full md:w-1/2 p-4">
            <div class="flex justify-center">
                <picture fetchpriority="high" decoding="async" title="Bombas para industria 1">
                    <source type="image/webp" sizes="(max-width: 600px) 100vw, 600px" srcset="/img/Bombas-para-obra-civil-y-urbanistica.png.webp 600w" />
                    <img fetchpriority="high" decoding="async" width="600" height="600" src="/img/Bombas-para-obra-civil-y-urbanistica.png.webp" alt="bombas para industria" sizes="(max-width: 600px) 100vw, 600px" class="max-w-full h-auto border-0" />
                </picture>
            </div>
        </div>
    </div>
    ...
    <div class="box-border relative w-full flex-row flex-nowrap justify-normal items-normal content-normal gap-normal flex-auto">
        <div class="box-border transition-all duration-300 ease-in-out">
            <div class="box-border px-1 md:px-1">
                ...
                <h2 class="text-[20px] md:text-[20px] text-[rgb(41,83,177)] font-semibold box-border text-left">
    ...
    <div class="w-full md:w-3/4 flex flex-wrap px-1 py-0 mx-auto">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="https://bombasellos.com.mx:/bombas-sumergibles-con-sistema-triturador">
                            <picture decoding="async" title="Bombas para obra civil y urbanistica 2" class="box-border">
                ...
                <div class="box-border transition-all ease-in-out">
                    <div>
                        <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                            <a href="https://bombasellos.com.mx:/bombas-sumergibles-con-sistema-triturador" class="text-[#007bff] no-underline bg-transparent">
            ...
            <div class="relative w-full text-left flex flex-row justify-center">
                <div class="box-border m-0 transition-all ease-in-out">
                    <div>
                        <a href="https://bombasellos.com.mx:/bombas-sumergibles-con-sistema-triturador" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                            <span class="flex justify-center">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
                ...
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="https://bombasellos.com.mx:/bombas-calpeda/duplicado-bombas-sumergibles-con-sistema-triturador-gqg-1956/">
                            <picture decoding="async" title="Bombas para obra civil y urbanistica 3" class="box-border">
            ...
            <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
                <div class="box-border m-0 p-0 transition-all ease-in-out">
                    <div>
                        <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Submersible Sewage and Drainage Pumps.</p>
                    </div>
                </div>
            </div>
            <div class="relative w-full text-left flex flex-row justify-center">
                ...
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="https://bombasellos.com.mx:/bombas-calpeda/bomba-sumergible-para-achiques-gm-10/">
                            <picture decoding="async" title="Bombas para obra civil y urbanistica 4" class="box-border">
                ...
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="https://bombasellos.com.mx:/bombas-calpeda/bomba-sumergible-de-acero-inoxidable-gxr-gxv/">
                            <picture decoding="async" title="Bombas para obra civil y urbanistica 5" class="box-border">
                ...
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="https://bombasellos.com.mx:/bombas-calpeda/bomba-sumergible-para-achiques-gqr/">
                            <picture decoding="async" title="Bombas para obra civil y urbanistica 6" class="box-border">
                ...
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="https://bombasellos.com.mx:/bombas-calpeda/bombas-sumergibles-de-acero-inoxidable-para-aguas-sucias-gx40/">
                            <picture decoding="async" title="Bombas para obra civil y urbanistica 7" class="box-border">
                                <source type="image/webp" srcset="/img/Bombas-sumergibles-de-acero-inoxidable-para-aguas-sucias.jpg.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                                <img decoding="async" width="300" height="490" src="/img/Bombas-sumergibles-de-acero-inoxidable-para-aguas-sucias.jpg" alt="Bombas sumergibles de acero inoxidable para aguas sucias" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                            </picture>
                        </a>
                    </div>
                </div>
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
                ...
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="https://bombasellos.com.mx:/bombas-calpeda/bombas-sumergibles-para-aguas-sucias-gqs-gqv/">
                            <picture decoding="async" title="Bombas para obra civil y urbanistica 8" class="box-border">
            ...
            <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
                <div class="box-border m-0 p-0 transition-all ease-in-out">
                    <div>
                        <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bombas sumergibles para aguas sucias.</p>
                    </div>
                </div>
            </div>
            <div class="relative w-full text-left flex flex-row justify-center">
                ...
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="https://bombasellos.com.mx:/bombas-calpeda/bombas-sumergibles-para-aguas-sucias-gm-50/">
                            <picture decoding="async" title="Bombas para obra civil y urbanistica 9" class="box-border">
