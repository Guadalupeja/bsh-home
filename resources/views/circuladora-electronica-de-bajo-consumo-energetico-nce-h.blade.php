...
@section('title', 'Circuladora electrónica de bajo consumo energético NCE H')
@section('description', 'Circuladora electrónica de bajo consumo energético NCE H - CALPEDA Entrega Inmediata. 
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Service",
  "serviceType": "Venta y mantenimiento de bombas circuladoras NCE H",
  "provider": {
    "@type": "Organization",
    "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)",
    "contactPoint": {
                                    ...
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        <div class="swiper-container">
                                           <figure class="m-0 mt-2 block leading-[27px]">
                                                <picture decoding="async" title="Circuladora electrónica de bajo consumo energético - NCE H">
                                                    <source type="image/webp" srcset="/img/NCE_H_F_web1920-1024x1024.jpg" />
                                                    <img decoding="async" src="/img/NCE_H_F_web1920-1024x1024.jpg" alt="Circuladora electrónica de bajo consuno energético---NCE-H" class="max-w-full h-auto align-middle border-none" />
                                                </picture>
                                            </figure>
                                        </div>
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="leading-[23px] mb-8 mt-0 box-border text-gray-600 font-bold">
                                                        Ejecución
                                                    </p>
                                                    <p class="leading-[23px] mb-8 mt-0 box-border text-gray-600">
                                                    ...
                                                    <p class="leading-[23px] mb-2 mt-0 box-border text-gray-600 font-bold">
                                                        Aplicaciones
                                                    </p>
                                                    <p class="leading-[23px] mb-8 mt-0 box-border text-gray-600">
                                                        <br/>Sistemas de calefacción y de aire acondicionado.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Circuladora electrónica de bajo consumo energético                                            </div>
                                        </div>
                                    </h1>
                                </div>
                            </div>
