...
@section('title', 'Sistema presurizado con control de presión integrado - E-NGX')
@section('description', 'Sistema presurizado con control de presión integrado E-NGX CALPEDA. Entrega Inmediata. 
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "E-NGX Sistema presurizado con control de presión integrado",
      "description": "Sistema presurizado con control de presión integrado E-NGX de Calpeda. Fácil de instalar, compacto, con motor asíncrono monofásico y protección avanzada. Ideal para instalaciones domésticas e industriales.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      ...
      "category": "Pumps",
      "image": [
        "/img/Sistema-presurizado-con-control-de-presion-integrado-emax-1-1.png.webp"
      ],
      "offers": {
        "@type": "Offer",
        "url": "https://bombasellos.com.mx/e-ngx-sistema-presurizado-control-presion",
        "priceCurrency": "MXN",
        "price": "32000",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://bombasellos.com.mx/e-ngx-sistema-presurizado-control-presion"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "E-NGX Sistema presurizado con control de presión",
          "item": "https://bombasellos.com.mx/e-ngx-sistema-presurizado-control-presion"
        }
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Qué es el sistema presurizado E-NGX?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "El sistema presurizado E-NGX de Calpeda es una solución compacta con control de presión integrado, ideal para aplicaciones domésticas e industriales, proporcionando alta eficiencia en el control de flujo y presión."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cuáles son las características del sistema E-NGX?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "El E-NGX cuenta con motor monofásico asíncrono, protección contra sobrecalentamiento y sobrecarga, control de presión programable, y monitoreo de corriente. Es ideal para aplicaciones donde se requiere un control preciso de la presión."
          }
        },
        {
          "@type": "Question",
          "name": "¿Dónde puedo comprar el sistema E-NGX?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "El sistema presurizado E-NGX está disponible en nuestra tienda en línea y en sucursales en todo México. Ofrecemos precios competitivos y soporte técnico especializado."
          }
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "serviceType": "Venta y mantenimiento de sistemas presurizados E-NGX",
      "provider": {
        "@type": "Organization",
        "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)",
        "contactPoint": {
      ...
      "description": "Ofrecemos venta, instalación y mantenimiento especializado de sistemas presurizados E-NGX de Calpeda. Distribuidor mayorista con soporte técnico experto en México."
    }
    </script>
                                    ...
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        <div class="swiper-container">
                                            ...
                                            <figure class="m-0 block leading-[27px]">
                                                <picture decoding="async" title="E-NGX Sistema presurizado con control de presión integrado">
                                                    <source type="image/webp" srcset="/img/Sistema-presurizado-con-control-de-presion-integrado-emax-1-1.png.webp" /> 
                                                    <img decoding="async" src="/img/Sistema-presurizado-con-control-de-presion-integrado-emax-1-1.png.webp" alt="E-NGX Sistema presurizado con control de presión integrado" class="max-w-full h-auto align-middle border-none shadow-none" />
                                                </picture>
                                            </figure>
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-gray-600 leading-[23px] mb-8 mt-0 font-bold">Construcción</p>
                                                    <p class="text-gray-600 leading-[23px] mb-8 mt-0">
                                                        ...
                                                        Equipado con un software programable y, gracias al sensor de presión analógico, el producto permite configurar la presión de reinicio. 
                                                        Una solución ideal que permite reducir o eliminar la necesidad de un tanque de expansión.
                                                    </p>
                                        
                                                    <p class="text-gray-600 leading-[23px] mb-8 mt-0 font-bold">Características</p>
                                                    <p class="text-gray-600 leading-[23px] mb-8 mt-0">
                                                        ...
                                                        – monitoreo de la corriente de arranque máxima<br />
                                                        – eliminación del golpe de ariete
                                                    </p>
                                        
                                                    <p class="text-gray-600 leading-[23px] mb-8 mt-0 font-bold">Protecciones</p>
                                                    <p class="text-gray-600 leading-[23px] mb-8 mt-0">
                                                        – Protección contra marcha en seco<br />
                                    ...
                                    <div class="relative w-full flex justify-center">
                                        <div class="transition-all duration-300">
                                            <picture decoding="async" title="Curve MXA">
                                                <source type="image/webp" srcset="/img/E-NGX_curve-1-1024x670.png 999w" sizes="(max-width: 999px) 100vw, 999px" />
                                                <img decoding="async" width="999" height="651" src="/img/E-NGX_curve-1-1024x670.png" alt="Curve GNX" srcset="/img/E-NGX_curve-1-1024x670.png 999w, /img/E-NGX_curve-1-1024x670.png 300w, /img/E-NGX_curve-1-1024x670.png 768w" sizes="(max-width: 999px) 100vw, 999px" class="max-w-full h-auto align-middle border-none inline-block" />
                                            </picture>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/ES%20-%20Espa%C3%B1ol/DIVISI/E-NGX_ES.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar<br />Catálogo 50 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
