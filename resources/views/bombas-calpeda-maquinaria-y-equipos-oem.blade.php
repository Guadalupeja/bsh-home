...
@section('title', 'Bombas para Maquinaria y Equipos (OEM) | Calpeda® MX')
@section('description', 'Bombas Centrifugas Calpeda® para maquinaria y equipos (OEM). Entrega Inmediata. 
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Bombas para Maquinaria y Equipos (OEM) - Calpeda®",
  "description": "Bombas Centrifugas Calpeda® para maquinaria y equipos (OEM). Disponibles con entrega inmediata, fabricadas por la marca premium italiana Calpeda. Ofrecemos distribución mayorista, así como refacciones y mantenimiento.",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Bombas para Maquinaria y Equipos (OEM)",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué tipos de bombas para OEM ofrecen?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ofrecemos bombas monobloc, multicelulares, de aspiración axial, entre otras para maquinaria y equipos OEM."
      }
    },
    {
      "@type": "Question",
                ...
                <div class="bg-transparent mb-0 box-border">
                    <div class="box-border">
                        <ul class="bg-transparent m-0 p-0 inline-flex mb-0 list-none flex-wrap rounded-lg mt-0 box-border">
                            ...
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto"><span class="text-[#043e81] px-1">/</span></li>
                            <li><a href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-industria-bombas-centrifugas-monobloc-bombas-multicelulares-horizontales/" class="text-[#043e81] hyphens-auto no-underline bg-transparent box-shadow-none">Bombas para industria</a></li>
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto"><span class="text-[#043e81] px-1">/</span></li>
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto">Bombas Calpeda –  Maquinaria y equipos (OEM)</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="w-full lg:w-3/4 flex flex-wrap px-1 py-0 mx-auto">
           ...
           <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap">
               <div class="box-border transition-all ease-in-out group">
                   <div class="box-border block relative z-10 overflow-hidden text-center">
                       <picture fetchpriority="high" decoding="async" title="Bombas Calpeda - Maquinaria y equipos (OEM) 1" class="box-border">
       ...
       <div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
           <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap">
               <div class="box-border transition-all ease-in-out group">
                   <div class="box-border block relative z-10 overflow-hidden text-center">
                       <picture decoding="async" title="Bombas Calpeda - Maquinaria y equipos (OEM) 2" class="box-border">
                           <source type="image/webp" srcset="/img/Bombas-centrifugas-monobloc-con-bridas-nm-nms-1.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                           <img decoding="async" width="300" height="490" src="/img/Bombas-centrifugas-monobloc-con-bridas-nm-nms-1.png" alt="Bomba monobloc de aspiración axial en bronce" srcset="/img/Bombas-centrifugas-monobloc-con-bridas-nm-nms-1.png 300w, /img/Bombas-centrifugas-monobloc-con-bridas-nm-nms-1-184x300.png 184w" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                       </picture>
                   </div>
               </div>
           </div>
       ...
       <div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
           <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap">
               <div class="box-border transition-all ease-in-out group">
                   <div class="box-border block relative z-10 overflow-hidden text-center">
                       <picture loading="lazy" decoding="async" title="Bombas Calpeda - Maquinaria y equipos (OEM) 10" class="box-border">
                           <source type="image/webp" srcset="/img/CT.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                           <img loading="lazy" decoding="async" width="300" height="490" src="/img/CT.png" alt="Bomba de impulsor vortex." srcset="/img/CT.png 300w, /img/CT-184x300.png 184w" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                       </picture>
                   </div>
               </div>
           </div>
           <div class="mb-2 relative w-full flex flex-row">
               <div class="box-border transition-all ease-in-out">
                   <div>
                       <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                           <a href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-industria-bombas-centrifugas-monobloc-bombas-multicelulares-horizontales/bombas-calpeda-maquinaria-y-equipos-oem/ct-bomba-con-rodete-periferico/" class="text-[#007bff] no-underline bg-transparent">
                               <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bomba CT</span>
                           </a>
                       </h2>
                   </div>
               </div>
           ...
           <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10">
               <div class="box-border m-0 p-0 transition-all ease-in-out">
                   <div>
                       <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bomba monobloc con impulsor periférico.</p>
                   </div>
               </div>
           </div>
           <div class="relative w-full text-left flex flex-row">
               <div class="box-border m-0 transition-all ease-in-out">
                   <div>
                       <a href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-industria-bombas-centrifugas-monobloc-bombas-multicelulares-horizontales/bombas-calpeda-maquinaria-y-equipos-oem/ct-bomba-con-rodete-periferico/" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                           <span class="flex justify-center">
                               <span class="mr-1 order-5 flex-grow-0">
                                   <i class="fas fa-plus text-white py-3"></i>
                               </span>
