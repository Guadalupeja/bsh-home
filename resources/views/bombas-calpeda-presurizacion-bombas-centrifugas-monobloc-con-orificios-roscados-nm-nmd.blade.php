...
@section('title', 'Bomba centrífuga presurizadora líquidos limpios | Calpeda NM')
@section('description', 'Cotiza Bomba centrífuga presurizadora líquidos limpios | Calpeda NM Entrega Inmediata. Marca Premium 
Distribuidor Mayorista MX. Mejor Precio Refacciones y Mto.')
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bomba centrífuga presurizadora de líquidos limpios | Calpeda NM",
      "description": "Cotiza Bomba centrífuga presurizadora de líquidos limpios | Calpeda NM con entrega inmediata. Marca premium y distribuidor mayorista en México. Mejor precio en refacciones y mantenimiento.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      ...
      "mpn": "NM-001",
      "image": [
        "/img/Bombas-centrifugas-monobloc-con-orificios-roscados-nm-nmd.png.webp",
        "/img/NM_NMD_curve-1024x632.png"
      ],
      "offers": {
        "@type": "Offer",
      ...
      "review": [
        {
          ...
          "reviewBody": "Excelente bomba, muy robusta y eficiente. Ideal para sistemas de presurización en proyectos industriales."
        },
        {
          "@type": "Review",
          "reviewRating": {
          ...
          "reviewBody": "Funciona bien, pero la instalación requiere un técnico especializado."
        }
      ],
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://bombasellos.com.mx/bombas-centrifugas-presurizadoras-calpeda-nm"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 5,
          "name": "Bomba centrífuga presurizadora líquidos limpios | Calpeda NM",
          "item": "https://bombasellos.com.mx/bombas-centrifugas-presurizadoras-calpeda-nm"
        }
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Para qué aplicaciones es ideal la Bomba NM de Calpeda?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La Bomba NM de Calpeda es ideal para la presurización de líquidos limpios en aplicaciones civiles, industriales y agrícolas, gracias a su robustez y eficiencia."
          }
        },
        {
          "@type": "Question",
          "name": "¿Qué variantes de impulsor están disponibles para la Bomba NM?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La Bomba NM está disponible con impulsores de hierro, bronce o latón, ofreciendo opciones según la compatibilidad con el fluido."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cuál es la capacidad máxima de la Bomba NM?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La Bomba NM tiene una capacidad máxima de hasta 66 m3/h, con una altura máxima de elevación de 114 metros."
          }
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "serviceType": "Venta y mantenimiento de bombas centrífugas",
      "provider": {
        "@type": "Organization",
        "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)"
      },
      "description": "Ofrecemos venta, instalación y mantenimiento especializado de bombas centrífugas presurizadoras. Distribuidor mayorista en México con soporte técnico experto."
    }
    </script>
                        ...
                        <div class="relative z-20 box-border">
                            <div class="bg-transparent box-border">
                                <ul class="bg-transparent m-0 p-0 inline-flex list-none flex-wrap rounded-lg box-border">
                                    ...
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto">Bombas centrífugas monobloc con orificios roscados – NM NMD</li>
                                </ul>                                
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div aria-live="off" class="box-content transform-none relative w-full h-[489.047px] z-[1] flex transition-transform">
                                                            <div role="group" aria-roledescription="slide" aria-label="1 de 1" class="box-border flex-shrink-0 w-full h-[489.047px] relative max-w-full text-center">
                                                                <figure class="m-0 block box-border leading-[23px]">
                                                                    <picture decoding="async" title="Bomba NM, NMD - Bomba centrífuga monobloc" class="box-border">
                                                                        <source type="image/webp" srcset="/img/Bombas-centrifugas-monobloc-con-orificios-roscados-nm-nmd.png.webp" class="box-border" />
                                                                        <img alt="Bomba centrífuga monobloc NM NMD" src="/img/Bombas-centrifugas-monobloc-con-orificios-roscados-nm-nmd.png.webp" decoding="async" class="max-w-full h-auto align-middle border-none box-border" />
                                                                    </picture>
                                                                </figure>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="leading-[23px] mb-[32px] mt-0 text-[#666666]">
                                                        Bombas centrífugas monobloc para líquidos sin contenidos sólidos en aplicaciones civiles, industriales e irrigación agrícola.
                                                    </p>
                                                    <p class="leading-[23px] mb-[32px] mt-0 text-[#666666]">
                                                        NM integra un solo impulsor mientras NMD dos rodetes contrapuestos.
                                                    </p>
                                                    <p class="leading-[23px] mb-[32px] mt-0 text-[#666666]">
                                                        Una bomba robusta de alta fiabilidad en todas las condiciones de funcionamiento.
                                                    </p>
                                                    <p class="leading-[23px] mb-[32px] mt-0 text-[#666666]">
                                                        Amplio rango de materiales de construcción para garantizar la mejor compatibilidad con el fluido.
                                                    </p>
                                                    <ul class="list-disc pl-[15px] mt-0 mb-0">
                                                        <li class="font-normal text-left">Cuerpo de bomba y acoplamientos en Hierro EN 1561 o Bronce EN 1982.</li>
                                                        <li class="font-normal text-left">Impulsor en Hierro, Bronce o Latón.</li>
                                                        <li class="font-normal text-left">Eje en aceros inoxidables Cr, Cr-Ni, Cr-Ni-Mo.</li>
                                                        <li class="font-normal text-left">Motores trifásicos 230/400/690 V o monofásico 230 V.</li>
                                                        <li class="font-normal text-left">Qmax. 66 m3/h</li>
                                                        <li class="font-normal text-left">Hmax. 114 m.</li>
                                                    </ul>
                                                </div>

                                                <div data-id="7486efe" data-element_type="widget" data-widget_type="video.default" style="box-sizing:border-box;--widgets-spacing: 20px 20px;margin-block-end:20px;--swiper-theme-color: #000;--swiper-navigation-size: 44px;--swiper-pagination-bullet-size: 6px;--swiper-pagination-bullet-horizontal-gap: 6px;margin-bottom:20px;position:relative;width: 100%;flex-direction:row;flex-wrap:nowrap;justify-content:normal;align-items:normal;align-content:normal;gap:normal;--flex-direction: initial;--flex-wrap: initial;--justify-content: initial;--align-items: initial;--align-content: initial;--gap: initial;--flex-basis: initial;--flex-grow: initial;--flex-shrink: initial;--order: initial;--align-self: initial;flex-basis:auto;flex-grow:0;flex-shrink:1;order:0;align-self:auto;">
                                                    <div style="box-sizing:border-box;overflow:hidden;transform:matrix(1, 0, 0, 1, 0, 0);transition:background 0.3s, border 0.3s, border-radius 0.3s, box-shadow 0.3s, transform 0.4s;">
                                                        <div style="box-sizing:border-box;--video-aspect-ratio: 1.77777;aspect-ratio:1.77777 / 1;"><iframe width="560" height="315" src="https://www.youtube.com/embed/Ggd7r3PBIrc?si=JSLKM5_mQhqaEvgI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
                                                    </div>
                                                </div>
                                                <div data-id="714e7c1" data-element_type="widget" data-widget_type="video.default" style="box-sizing:border-box;--widgets-spacing: 20px 20px;--swiper-theme-color: #000;--swiper-navigation-size: 44px;--swiper-pagination-bullet-size: 6px;--swiper-pagination-bullet-horizontal-gap: 6px;position:relative;width: 100%;flex-direction:row;flex-wrap:nowrap;justify-content:normal;align-items:normal;align-content:normal;gap:normal;--flex-direction: initial;--flex-wrap: initial;--justify-content: initial;--align-items: initial;--align-content: initial;--gap: initial;--flex-basis: initial;--flex-grow: initial;--flex-shrink: initial;--order: initial;--align-self: initial;flex-basis:auto;flex-grow:0;flex-shrink:1;order:0;align-self:auto;">
                                                    <div style="box-sizing:border-box;overflow:hidden;transform:matrix(1, 0, 0, 1, 0, 0);transition:background 0.3s, border 0.3s, border-radius 0.3s, box-shadow 0.3s, transform 0.4s;">
                                                        <div style="box-sizing:border-box;--video-aspect-ratio: 1.77777;aspect-ratio:1.77777 / 1;"><iframe width="560" height="315" src="https://www.youtube.com/embed/kfu6sKGkECk?si=-wqNv5dMRBER4FsL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas centrífugas monobloc con conexiones roscadas.
                                            </div>
                                        </div>
                                    </h1>                                     
                                </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:my-[350px] mx-0 p-2.5 flex w-full flex-wrap content-start">
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    <div data-id="7ce4ff1" data-element_type="widget" data-widget_type="image.default" class="box-border text-center w-full flex-row flex-nowrap relative">
                                        <div class="transition-all duration-300">
                                            <a href="/img/NM_NMD_curve-1024x632.png" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="curve_NM-NMD" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjAyMywidXJsIjoiaHR0cHM6XC9cL2JvbWJhc2VsbG9zLmNvbS5teFwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyMFwvMDRcL2N1cnZlX0dRUy1HUVYuanBnIn0%3D" class="text-[#007bff] no-underline bg-transparent inline-block shadow-none">
                                                <picture fetchpriority="high" decoding="async" title="Bombas Centrífugas Monobloc NM, NMD" class="box-border">
                                                    <source type="image/webp" sizes="(max-width: 929px) 100vw, 929px" srcset="/img/NM_NMD_curve-1024x632.png 929w, /img/NM_NMD_curve-1024x632.png 300w, /img/NM_NMD_curve-1024x632.png 768w" />
                                                    <img fetchpriority="high" width="929" height="549" alt="curve NM, NMD" sizes="(max-width: 929px) 100vw, 929px" srcset="/img/NM_NMD_curve-1024x632.png 929w, /img/NM_NMD_curve-1024x632.png 300w, /img/NM_NMD_curve-1024x632.png 768w" class="max-w-full h-auto align-middle border-none inline-block" />
                                                </picture>
                                            </a>
                                        </div>
                                    </div>
