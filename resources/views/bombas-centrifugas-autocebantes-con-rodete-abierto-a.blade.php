...
@section('title', 'Bombas centrífugas autocebantes con rodete abierto A CALPEDA')
@section('description', '
Cotiza aquí Bombas centrífugas A CALPEDA con rodete abierto. Entrega Inmediata. 
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Bombas centrífugas autocebantes con rodete abierto A CALPEDA",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
  "description": "Cotiza aquí Bombas centrífugas A CALPEDA con rodete abierto. Entrega Inmediata. Marca Premium Italiana. Distribuidor Mayorista. Refacciones y Mantenimiento.",
  "sku": "CALP-A-123456",
  "mpn": "A-123456",
  "category": "Industrial Pumps",
  "image": [
    "/img/Bombas-centrifugas-autocebantes-con-rodete-abierto-A.jpg.webp",
    "/img/Bombas-centrifugas-autocebantes-con-rodete-abierto-A3.jpg.webp",
    "/img/Bombas-centrifugas-autocebantes-con-rodete-abierto-A2.jpg.webp"
  ],
  "offers": {
    "@type": "Offer",
  ...
  "review": [
    {
      ...
      "reviewBody": "Excelente bomba, funciona perfectamente para mis necesidades industriales."
    }
  ],
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://bombasellos.com.mx/bombas-centrifugas-autocebantes-calpeda"
  }
}
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Bombas centrífugas autocebantes con rodete abierto A",
      "item": "https://bombasellos.com.mx/bombas-centrifugas-autocebantes-calpeda"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué son las bombas centrífugas autocebantes con rodete abierto A CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las bombas centrífugas autocebantes con rodete abierto A CALPEDA están diseñadas para aplicaciones industriales y civiles que requieren manejo de agua limpia o ligeramente sucia, incluso con sólidos. Son ideales para sistemas de riego, drenaje, y aplicaciones industriales."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cuál es el precio de las bombas CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "El precio de las bombas CALPEDA varía según el modelo y las especificaciones. Para más detalles, visita nuestro sitio web o contacta con nuestro equipo de ventas."
      }
    },
    {
      "@type": "Question",
      "name": "¿Dónde puedo comprar bombas CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Puedes comprar bombas CALPEDA a través de nuestro sitio web o visitando nuestras sucursales. Ofrecemos entrega inmediata y soporte técnico especializado."
      }
    }
  ]
}
                ...
                <div class="max-w-[1190px] mx-auto flex flex-col lg:flex-row">
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/Bombas-centrifugas-autocebantes-con-rodete-abierto-A.jpg.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/Bombas-centrifugas-autocebantes-con-rodete-abierto-A3.jpg.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 3 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/Bombas-centrifugas-autocebantes-con-rodete-abierto-A2.jpg.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                                </div>
                                            </div>
                                            <!-- Add Pagination -->
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-[#666] leading-[27px] mb-8 text-justify">
                                                        Bomba centrífuga monobloc autocebante con rodete abierto. La válvula de retención incorporada en la bomba impide, en el paro, el efecto sifón y asegura la autoaspiración automática en cada nueva puesta en marcha. La bomba autoaspira aunque la válvula de retención no cierre perfectamente, estando la bomba parcialmente llena de agua y con el tubo de aspiración completamente vacío. A: Ejecución con cuerpo bomba y acoplamiento en hierro. B-A: Ejecución con cuerpo bomba y acoplamiento en bronce. Las bombas en bronce se suministran totalmente pintadas.
                                                    </p>
                                                    ...
                                                    <p class="text-[#666] leading-[27px] mb-8">
                                                        – Para agua limpia o ligeramente sucia, aún conteniendo cuerpos sólidos hasta 10 mm para A 40-110, A 50-125 y 15 mm para A 65-150, A 80-170.- Para el vaciado de sótanos, fosas, achiques, etc.- Para riegos por gravedad.- Para aplicaciones civiles e industriales.
                                                    </p>
                    ...
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex flex-wrap content-start">
                        <div class="relative w-full">
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">A</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">ELECTROBOMBAS AUTOASPIRANTES</div>
                                        </div>
                                    </h1>
                                </div>
                                ...
                                <div class="relative w-full flex flex-row flex-nowrap mb-5 text-gray-500 font-roboto font-normal">
                                    <div class="transition-all duration-300">
                                        <p class="text-[#666666] leading-[23px] mb-4 mt-8">
                                            Bombas centrífugas autocebantes con rodete abierto
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none my-[160px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                ...
                                <section class="block box-border my-5 mx-0 relative w-full">
                                    <div class="max-w-[1190px] box-border mx-auto flex relative">
                                        <div class="w-full box-border relative flex flex-wrap justify-center items-center">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div class="box-border text-center relative w-full">
                                                    <div class="box-border transition-all duration-300 ease-in-out transform">
                                                        <picture fetchpriority="high" decoding="async" title="A - Electrobomba autoaspirante" class="box-border">
                                                            <source type="image/webp" srcset="/img/curve_A-2.jpg.webp 1024w, /img/curve_A-2.jpg.webp 300w, /img/curve_A-2.jpg.webp 768w, /img/curve_A-2.jpg.webp 600w, /img/curve_A-2.jpg.webp 1240w" sizes="(max-width: 768px) 100vw, 768px" class="box-border" />
                                                            <img fetchpriority="high" decoding="async" width="768" height="290" src="/img/curve_A-2.jpg.webp" alt="Aplicaciones electrobomba A Calpeda" class="max-w-[30%] h-auto align-middle border-none box-border inline-block shadow-none" />
                                                        </picture>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://hubs.ly/H0pT2J20" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Download<br />50 Hz Catalogue</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <section data-id="5996584" class="block box-border w-full relative">
                                    <div class="max-w-[1190px] mx-auto flex relative">
                                        <div data-id="578dc72" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="0784181" class="box-border text-center relative w-full flex flex-row flex-nowrap justify-end">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <a href="https://hubs.ly/H0pT2J20" target="_blank" rel="noopener" class="text-[#007bff] no-underline bg-transparent inline-block box-shadow-none">
                                                            <picture decoding="async" title="Bombas centrífugas autocebantes con rodete abierto - A 28">
                                                                <source type="image/webp" srcset="/img/download-2.png.webp" />
                                        ...
                                        <div data-id="1f61649" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="dd8d718" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://hubs.ly/H0pT2J_0" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descarga<br />Catálogo 60 Hz</a><br>
                                                            <a href="https://es.calpeda.com/system/products/catalogue_50hzs/242/es/A_SPA2019.pdf?1586965678" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descarga<br />Instrucciones</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://hubs.ly/H0pT2J_0" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descarga<br />Instrucciones</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
