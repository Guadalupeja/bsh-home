...
@section('title', 'Bombas Sumergibles de Pozo 6, 8, 10 pulgadas| Calpeda SDS')
@section('description', 'Cotiza Bombas Sumergibles SDS de Pozo de 4 hasta 10" CALPEDA. Entrega Inmediata. Distribuidor Mayorista MX. Sellos Mecánicos, Refacciones y Mantenimiento.')
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Bombas Sumergibles de Pozo Calpeda SDS",
  "description": "Cotiza Bombas Sumergibles SDS de Pozo de 6”, 8” y 10” con entrega inmediata. Distribuidor mayorista en México. Mejores precios y soporte técnico especializado.",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
  ...
  "image": [
    "/img/SDS-Bombas-sumergibles-para-pozos-de-6-8-y-10.png.webp",
    "/img/curve_SDS.jpg.webp"
  ],
  "offers": {
    "@type": "Offer",
    "url": "https://bombasellos.com.mx/bombas/sumergibles/",
    "priceCurrency": "MXN",
    "price": "20000",
  ...
  "review": [
    {
      ...
      "reviewBody": "Excelente rendimiento en aplicaciones de pozo profundo. Durabilidad y eficiencia garantizada."
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "Funciona muy bien, aunque la instalación fue un poco compleja."
    }
  ],
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://bombasellos.com.mx/bombas/sumergibles/"
  }
}
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Sumergibles",
      "item": "https://bombasellos.com.mx/bombas/sumergibles/"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Bombas Sumergibles Calpeda SDS",
      "item": "https://bombasellos.com.mx/bombas/sumergibles/"
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Para qué aplicaciones son ideales las Bombas Sumergibles SDS de Calpeda?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las Bombas Sumergibles SDS de Calpeda son ideales para la extracción de agua de pozos profundos en aplicaciones industriales y agrícolas."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué materiales se utilizan en la construcción de las Bombas Sumergibles SDS?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las Bombas Sumergibles SDS están construidas en acero inoxidable y tienen impulsores de alta resistencia."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cuál es la capacidad máxima de las Bombas Sumergibles SDS?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las Bombas Sumergibles SDS tienen una capacidad máxima de hasta 350 m³/h, con una altura máxima de elevación de 470 metros."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Service",
  "serviceType": "Venta y mantenimiento de Bombas Sumergibles SDS",
  "provider": {
    "@type": "Organization",
    "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)",
    "contactPoint": {
  ...
  "description": "Ofrecemos venta, instalación y mantenimiento especializado de Bombas Sumergibles SDS. Distribuidor mayorista en México con soporte técnico experto."
}
</script>
                        ...
                        <div class="relative z-20 box-border">
                            <div class="bg-transparent box-border">
                                <ul class="bg-transparent m-0 p-0 inline-flex list-none flex-wrap rounded-lg box-border">
                                    ...
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto">SDS Bombas sumergibles para pozos de 6 8 y 10</li>
                                </ul>                                
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div aria-live="off" class="box-content transform-none relative w-full h-[450px] z-[1] flex transition-transform">
                                                            <div role="group" aria-roledescription="slide" aria-label="1 de 1" class="box-border flex-shrink-0 w-full h-[450px] relative max-w-full text-center">
                                                                <figure class="m-0 block box-border leading-[23px]">
                                                                    <picture decoding="async" title="Bomba Sumergible SDS" class="box-border">
                                                                        <source type="image/webp" srcset="/img/SDS-Bombas-sumergibles-para-pozos-de-6-8-y-10.png.webp" class="box-border" />
                                                                        <img alt="Bomba Sumergible SDS" src="/img/SDS-Bombas-sumergibles-para-pozos-de-6-8-y-10.png.webp" decoding="async" class="min-w-[350px] h-[450px] align-middle border-none box-border" />
                                                                    </picture>
                                                                </figure>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-5">
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    ...
                                                    <div class="transition-all duration-300 bg-white p-4">
                                                        <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                                                            <span class="font-normal">Bombas sumergibles para pozos profundo de 6”, 8” y 10” de abasto municipal.&nbsp;</span>
                                                        </p>
                                                        <ul class="list-square ml-4 mb-0">
                                                            <li class="font-normal text-left"><span class="font-normal">Conexiones Bridadas para soldadura.</span></li>
                                                            <li class="font-normal text-left"><span class="font-normal">Válvula de retención incorporada al cuerpo de impulsores.</span></li>
                                                            <li class="font-normal text-left"><span class="font-normal">Impulsores semi-axiales.</span></li>
                                                            <li class="font-normal text-left"><span class="font-normal">Motores trifásicos de 230/440/690 V</span></li>
                                                            <li class="font-normal text-left"><span class="font-normal">Impulsores disponibles en Hierro o Bronce.</span></li>
                                                            <li class="font-normal text-left"><span class="font-normal">Eje de acero F51 Duplex.</span></li>
                                                            <li class="font-normal text-left"><span class="font-normal">Cuerpo, difusor y rodete en Hierro o Bronce, a petición.</span></li>
                                                            <li class="font-normal text-left"><span class="font-normal">Qmax. 350 m3/h</span></li>
                                                            <li class="font-normal text-left"><span class="font-normal">Hmax. 470 m.</span></li>
                                                        </ul>
                                                    </div>
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas Sumergibles para Pozos de 6”, 8” y 10”
                                            </div>
                                        </div>
                                    </h1>                                     
                                </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:mt-[350px] mx-0 p-2.5 flex w-full flex-wrap content-start">
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    <div data-id="7ce4ff1" data-element_type="widget" data-widget_type="image.default" class="box-border text-center w-full flex-row flex-nowrap relative">
                                        <div class="transition-all duration-300">
                                            <a href="/img/curve_SDS-1024x653.jpg.webp" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="curve_SDS" data-elementor-lightbox-description="Curva de operación bomba SDS" class="text-[#007bff] no-underline inline-block shadow-none">
                                                <picture fetchpriority="high" decoding="async" title="MXA - Bombas multicelulares autoaspirantes 2">
                                                    <source type="image/webp" sizes="(max-width: 547px) 100vw, 547px" srcset="/img/curve_SDS-1024x653.jpg.webp 547w, /img/curve_SDS-1024x653.jpg.webp 291w" />
                                                    <img fetchpriority="high" width="547" height="564" alt="Curva de operación bomba SDS" sizes="(max-width: 547px) 100vw, 547px" src="/img/curve_SDS-1024x653.jpg.webp" srcset="/img/curve_SDS-1024x653.jpg.webp 547w, /img/curve_SDS-1024x653.jpg.webp 291w" class="max-w-full h-auto align-middle border-none inline-block" />
                                                </picture>
                                            </a>
                                        </div>
                                    </div>
