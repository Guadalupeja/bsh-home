...
@section('title', 'Bomba GQG para agua con sólidos-lodos con sistema triturador')
@section('description', 'Cotiza bombas sumergibles CALPEDA para tratamiento y achique de aguas con contenidos 
sólidos con sistema triturador. Entrega inmediata MX y Precio Mayorista.')
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bomba GQG para agua con sólidos-lodos con sistema triturador",
      "description": "Cotiza bombas sumergibles CALPEDA para tratamiento y achique de aguas con contenidos sólidos con sistema triturador. Entrega inmediata MX y Precio Mayorista.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
                        ...
                        <div class="relative z-20 box-border">
                            <div class="bg-transparent box-border">
                                <ul class="bg-transparent m-0 p-0 inline-flex list-none flex-wrap rounded-lg box-border">
                                    ...
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-drenaje-y-tratamiento-de-aguas') }}" class="text-[#043E81] no-underline box-shadow-none">Bombas Calpeda – Drenaje y tratamiento de aguas.</a></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto">Bomba GQG – Bombas sumergibles con sistema triturador</li>
                                </ul>                                
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="w-full">
                                <div class="transition-all duration-300">
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                                            ...
                                                            <div role="group" aria-roledescription="slide" aria-label="1 de 1" class="box-border flex-shrink-0 w-full h-[489.047px] relative max-w-full text-center">
                                                                <figure class="m-0 block box-border leading-[23px]">
                                                                    <picture decoding="async" title="Bomba GQG - Bombas sumergibles con sistema triturador 1" class="box-border">
                                                                        <source type="image/webp" srcset="/img/Bombas-sumergibles-con-sistema-triturador-GQG.png.webp" />
                                                                        <img alt="Bombas Calpeda sumergibles con sistema triturador​" src="/img/Bombas-sumergibles-con-sistema-triturador-GQG.png.webp" decoding="async" class="max-w-full h-auto align-middle border-none box-border shadow-none" />
                                                                    </picture>
                                                                </figure>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="leading-[23px] mb-[32px] mt-0 box-border text-[#666666]">
                                                        <a class="font-sans text-base font-normal bg-white text-[#007bff] no-underline border-none shadow-none" href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-drenaje-y-tratamiento-de-aguas/" target="_blank" rel="noopener">Bombas sumergibles</a>
                                                        <span class="font-normal box-border">&nbsp;bridada de serie bajo la normativa Europea DN 32 (Consulte opciones para otras bridas) y con sistema triturador e interruptor de nivel.</span>
                                                    </p>
                                                    
                                                    <ul class="list-disc pl-4">
                                                        <li>Diseñada para el manejo de agua con contenidos sólidos de hasta 6 mm de diámetro.</li>
                                                        <li>Profundidad de Inmersión máxima de 0.3 m.</li>
                                                        <li>Sello mecánico de doble eje para proteger la bomba en caso de trabajo en seco.</li>
                                                        <li>Eje en acero Inoxidable.</li>
                                                        <li>Interruptor de nivel tipo flotador.</li>

                                                        <li>Cámara de aceite aislada para aplicaciones en farmacia y sector alimentario.</li>
                                                        <li>Cable de 10 m de logitud.</li>
                                                        <li>Mango de manipulación de acero inox recubierto de polipropileno.</li>
                                                        <li>Qmax. 17 m3/h</li>
                                                        <li>H max. 25 m.</li>
                                        ...
                                        <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                            <div data-id="06896a4" data-element_type="widget" data-settings='{"youtube_url":"https://www.youtube.com/watch?v=sjQzpHTaGXo","video_type":"youtube","controls":"yes"}' data-widget_type="video.default" class="box-border mb-5 relative w-full flex-row flex-nowrap">
                                                <div class="box-border overflow-hidden transition-all duration-300 ease-in-out">
                                                    <div class="box-border aspect-w-16 aspect-h-9">
                                                        <iframe width="560" height="315" src="https://www.youtube.com/embed/UerVi4sFEXk?si=7nNv97UuPecpNRZT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex flex-col lg:flex-wrap content-start">
                        <div class="relative w-full">
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bomba Sumergible GQG</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas sumergibles con sistema triturador</div>
                                        </div>
                                    </h1>


                                    <div class="box-border py-5 flex relative w-full flex-wrap content-start">
                                        <p class="leading-[23px] mb-[12px] mt-0 box-border text-[#666666]">
                                            Bombas centrifugas autocebantes con rodete abierto
                                        </p>
                                    </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:my-[255px] my-[45px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                        ...
                                        <div data-id="5e55c22" data-element_type="column" class="w-full box-border relative min-h-[1px] flex flex-wrap-none justify-normal items-normal content-normal">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="7ce4ff1" data-element_type="widget" data-widget_type="image.default" class="box-border text-center relative w-full flex-wrap-none justify-normal items-normal content-normal">
                                                    <div class="box-border transition-all duration-300 ease-in-out transform">
                                                        <img fetchpriority="high" decoding="async" width="994" height="591" src="/img/GQG_curve-1024x693.webp" alt="curve GQG" 
                                                        srcset="/img/GQG_curve-1024x693.webp 994w, 
                                                                /img/GQG_curve-1024x693.webp 300w, 
                                                                /img/GQG_curve-1024x693.webp 768w, 
                                                                /img/GQG_curve-1024x693.webp 600w" 
                                ...
                                <div class="box-border p-2.5 lg:mt-[154px] flex relative w-full flex-wrap content-start">
                                    <div data-id="b9d3ab5" data-element_type="widget" data-widget_type="video.default" class="box-border relative w-full flex-row flex-nowrap">
                                        <div class="box-border overflow-hidden transition-all duration-300 ease-in-out">
                                            <div class="box-border aspect-w-16 aspect-h-9">
                                                <iframe width="560" height="315" src="https://www.youtube.com/embed/yuHi55mH62A?si=Z9NF0-wBJ8tIsIed" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
