...
@section('title', 'Bombas de recirculación y aumento de presión | Calpeda®')
@section('description', 'Cotiza Bombas de recirculación, presurizadoras y de alimentación CALPEDA. 
En acero inoxidable, fundición y bronce. Entrega inmediata Mx y Precios Mayorista.')
                ...
                <div class="bg-transparent mb-0 box-border">
                    <div class="box-border">
                        <ul class="bg-transparent m-0 p-0 inline-flex mb-0 list-none flex-wrap rounded-lg mt-0 box-border">
                            ...
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto">Bombas Calpeda – Presurización</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="transition-all duration-300">
            ...
            <h1 class="text-[35px] leading-[44.5455px] mt-0 mb-0 font-semibold text-[#666666] font-['Open Sans'] box-border m-0 text-left break-all relative">
                <div class="inline-block relative z-10">
                    <div class="font-roboto font-bold text-[#043e81] text-[27px] inline-flex border-solid border-[#6ec1e4]">
                        Bombas Recirculadoras, Presurizadoras y de Alimentación.
                    </div>
...
<div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
    <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap">
        <div class="box-border transition-all ease-in-out group">
            <div class="box-border block relative z-10 overflow-hidden text-center">
                <picture loading="lazy" decoding="async" title="Bombas Calpeda - Bombas de alimentación a circuitos HVAC en la industria. 6" class="box-border">
    ...
    <div class="mb-2 relative w-full flex flex-row">
        <div class="box-border transition-all ease-in-out">
            <div>
                <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                    <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-mxh/" class="text-[#007bff] no-underline bg-transparent shadow-none">
...
<div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
    <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
        <div class="box-border transition-all ease-in-out group">
            <div class="box-border block relative z-10 overflow-hidden text-center">
                <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/bombas-multicelulares-horizontales-monobloc-mxp/">
                    <picture loading="lazy" decoding="async" title="Bombas Calpeda - Presurización 3" class="box-border">
                        <source type="image/webp" srcset="/img/bomba-mxp-calpeda.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                        <img decoding="async" width="300" height="490" src="/img/bomba-mxp-calpeda.png" alt="Bomba Monobloc en SS 304." sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                    </picture>
                </a>
            </div>
        </div>
    ...
    <div class="mb-2 relative w-full flex flex-row justify-center">
        <div class="box-border transition-all ease-in-out">
            <div>
                <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                    <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/bombas-multicelulares-horizontales-monobloc-mxp/" class="text-[#007bff] no-underline bg-transparent">
                        <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bomba MXP</span>
                    </a>
                </h2>
            </div>
        </div>
    ...
    <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
        <div class="box-border m-0 p-0 transition-all ease-in-out">
            <div>
                <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bombas multicelulares horizontales.</p>
            </div>
        </div>
    </div>
    <div class="relative w-full text-left flex flex-row justify-center">
        <div class="box-border m-0 transition-all ease-in-out">
            <div>
                <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/bombas-multicelulares-horizontales-monobloc-mxp/" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                    <span class="flex justify-center">
                        <span class="mr-1 order-5 flex-grow-0">
                            <i class="fas fa-plus text-white py-3"></i>
                        </span>
...
<div class="box-border p-1 lg:m-0 mx-auto flex relative w-full lg:w-1/3 flex-wrap content-start">
    <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap">
        <div class="box-border transition-all ease-in-out group">
            <div class="box-border block relative z-10 overflow-hidden text-center">
                <picture loading="lazy" decoding="async" title="Bombas Calpeda - Maquinaria y equipos (OEM) 7" class="box-border">
                    <source type="image/webp" srcset="/img/Bomba-mxv-b-calpeda.png.webp 300w, /img/Bomba-mxv-b-calpeda-184x300.png.webp 184w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                    <img loading="lazy" decoding="async" width="300" height="490" src="/img/Bomba-mxv-b-calpeda.png" alt="Bomba en linea en SS 304." srcset="/img/Bomba-mxv-b-calpeda.png 300w, /img/Bomba-mxv-b-calpeda-184x300.png 184w" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                </picture>
            </div>
        </div>
    </div>
...
<div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
    <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
        <div class="box-border transition-all ease-in-out group">
            <div class="box-border block relative z-10 overflow-hidden text-center">
                <a href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/ca-bombas-presurizacion/">
                    <picture loading="lazy" decoding="async" title="Bombas Calpeda - Presurización 6" class="box-border">
                        <source type="image/webp" srcset="/img/bomba-CA-calpeda.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                        <img decoding="async" width="300" height="490" src="/img/bomba-CA-calpeda.png" alt="Bomba autocebante en Bronce." sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                    </picture>
                </a>
            </div>
        </div>
    ...
    <div class="mb-2 relative w-full flex flex-row justify-center">
        <div class="box-border transition-all ease-in-out">
            <div>
                <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                    <a href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/ca-bombas-presurizacion/" class="text-[#007bff] no-underline bg-transparent">
                        <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bomba CA</span>
                    </a>
                </h2>
            </div>
        </div>
    ...
    <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
        <div class="box-border m-0 p-0 transition-all ease-in-out">
            <div>
                <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bombas autoaspirantes de anillo liquido</p>
            </div>
        </div>
    </div>
    <div class="relative w-full text-left flex flex-row justify-center">
        <div class="box-border m-0 transition-all ease-in-out">
            <div>
                <a href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/ca-bombas-presurizacion/" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                    <span class="flex justify-center">
                        <span class="mr-1 order-5 flex-grow-0">
                            <i class="fas fa-plus text-white py-3"></i>
                        </span>
...
<div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
    <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
        <div class="box-border transition-all ease-in-out group">
            <div class="box-border block relative z-10 overflow-hidden text-center">
                <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/ng-bombas-autoaspirantes-jet/">
                    <picture loading="lazy" decoding="async" title="Bombas Calpeda - Presurización 7" class="box-border">
                        <source type="image/webp" srcset="/img/Bomba-NG-calpeda.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                        <img decoding="async" width="300" height="490" src="/img/Bomba-NG-calpeda.png" alt="Bomba Jet autocebante en SS 430" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                    </picture>
                </a>
            </div>
        </div>
    ...
    <div class="mb-2 relative w-full flex flex-row justify-center">
        <div class="box-border transition-all ease-in-out">
            <div>
                <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                    <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/ng-bombas-autoaspirantes-jet/" class="text-[#007bff] no-underline bg-transparent">
                        <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bomba NG</span>
                    </a>
                </h2>
            </div>
        </div>
    ...
    <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
        <div class="box-border m-0 p-0 transition-all ease-in-out">
            <div>
                <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bombas autoaspirantes jet</p>
            </div>
        </div>
    </div>
    <div class="relative w-full text-left flex flex-row justify-center">
        <div class="box-border m-0 transition-all ease-in-out">
            <div>
                <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/ng-bombas-autoaspirantes-jet/" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                    <span class="flex justify-center">
                        <span class="mr-1 order-5 flex-grow-0">
                            <i class="fas fa-plus text-white py-3"></i>
                        </span>
...
<div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
    <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
        <div class="box-border transition-all ease-in-out group">
            <div class="box-border block relative z-10 overflow-hidden text-center">
                <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/mxa-bombas-multicelulares-autoaspirantes/">
                    <picture loading="lazy" decoding="async" title="Bombas Calpeda - Presurización 8" class="box-border">
                        <source type="image/webp" srcset="/img/Bomba-MXA-calpeda.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                        <img decoding="async" width="300" height="490" src="/img/Bomba-MXA-calpeda.png" alt="Bomba MXA Calpeda" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                    </picture>
                </a>
            </div>
        </div>
    ...
    <div class="mb-2 relative w-full flex flex-row justify-center">
        <div class="box-border transition-all ease-in-out">
            <div>
                <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                    <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/mxa-bombas-multicelulares-autoaspirantes/" class="text-[#007bff] no-underline bg-transparent">
                        <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bomba MXA</span>
                    </a>
                </h2>
            </div>
        </div>
    ...
    <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
        <div class="box-border m-0 p-0 transition-all ease-in-out">
            <div>
                <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bombas multicelulares autoaspirantes</p>
            </div>
        </div>
    </div>
    <div class="relative w-full text-left flex flex-row justify-center">
        <div class="box-border m-0 transition-all ease-in-out">
            <div>
                <a href="https://bombasellos.com.mx:/bombas-calpeda-presurizacion/mxa-bombas-multicelulares-autoaspirantes/" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                    <span class="flex justify-center">
                        <span class="mr-1 order-5 flex-grow-0">
                            <i class="fas fa-plus text-white py-3"></i>
                        </span>
