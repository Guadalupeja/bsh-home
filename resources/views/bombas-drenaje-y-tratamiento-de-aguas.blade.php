...
@section('title', 'Bombas sumergibles para aguas sucias con sólidos| Calpeda®')
@section('description', '
Cotiza aquí Bombas sumergibles Calpeda para aguas sucias.
Tratamiento y achique. Entrega Inmediata, Precios Mayorista, Asesoría en la selección y Garantías.')
...
<script type="application/ld+json">
    {
        ...
        "@type": "Product",
        "name": "Bombas sumergibles para aguas sucias con sólidos | Calpeda®",
        "description": "Cotiza aquí Bombas sumergibles Calpeda para aguas sucias, tratamiento y achique. Entrega inmediata, precios mayorista, asesoría en la selección y garantías.",
        "brand": {
          "@type": "Brand",
          "name": "Calpeda"
        },
        ...
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
            "url": "https://bombasellos.com.mx:/bombas-calpeda/bombas-sumergibles-con-sistema-triturador/",
            "name": "Bomba GQG"
          },
          {
            "@type": "ListItem",
            "position": 2,
            "url": "https://bombasellos.com.mx:/bombas-calpeda/duplicado-bombas-sumergibles-con-sistema-triturador-gqg-1956/",
            "name": "Bomba GQN"
          },
          {
            "@type": "ListItem",
            "position": 3,
            "url": "https://bombasellos.com.mx:/bombas-calpeda/bomba-sumergible-para-achiques-gm-10/",
            "name": "Bomba GM 10"
          },
          {
            "@type": "ListItem",
            "position": 4,
            "url": "https://bombasellos.com.mx:/bombas-calpeda/bomba-sumergible-de-acero-inoxidable-gxr-gxv/",
            "name": "Bomba GXR, GXV"
          },
          {
            "@type": "ListItem",
            "position": 5,
            "url": "https://bombasellos.com.mx:/bombas-calpeda/bomba-sumergible-para-achiques-gqr/",
            "name": "Bomba GQR"
          },
          {
            "@type": "ListItem",
            "position": 6,
            "url": "https://bombasellos.com.mx:/bombas-calpeda/bombas-sumergibles-de-acero-inoxidable-para-aguas-sucias-gx40/",
            "name": "Bomba GX 40"
          },
          {
            "@type": "ListItem",
            "position": 7,
            "url": "https://bombasellos.com.mx:/bombas-calpeda/bombas-sumergibles-para-aguas-sucias-gqs-gqv/",
            "name": "Bomba GQS, GQV"
          },
          {
            "@type": "ListItem",
            "position": 8,
            "url": "https://bombasellos.com.mx:/bombas-calpeda/bombas-sumergibles-para-aguas-sucias-gm-50/",
            "name": "Bomba GM 50"
          }
        ]
      }
            ...
            <h1 class="text-[35px] leading-[44.5455px] mt-0 mb-0 font-semibold text-[#666666] font-['Open Sans'] box-border m-0 text-left break-all relative">
                <div class="inline-block relative z-10">
                    <div class="font-roboto font-bold text-[#043e81] text-[27px] inline-flex border-solid border-[#6ec1e4]">
                        Bombas sumergibles para drenaje y tratamiento de aguas.
                    </div>
...
<div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
    ...
    <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
        <div class="box-border m-0 p-0 transition-all ease-in-out">
            <div>
                <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bomba sumergible para drenaje y alcantarillado.</p>
            </div>
        </div>
    </div>
    <div class="relative w-full text-left flex flex-row justify-center">
