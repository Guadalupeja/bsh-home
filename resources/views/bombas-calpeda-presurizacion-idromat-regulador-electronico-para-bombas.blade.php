...
@section('title', 'IDROMAT - Regulador electrónico para bombas | CALPEDA.')
@section('description', 'IDROMAT - Regulador electrónico para bombas CALPEDA. Entrega Inmediata. 
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "IDROMAT - Regulador electrónico para bombas",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      "description": "El IDROMAT es un regulador electrónico de presión para bombas que asegura el arranque automático de la bomba al detectar un flujo de agua y la desconecta al cerrar el suministro. Protege contra el funcionamiento en seco y otros riesgos, garantizando una operación segura y prolongada.",
      "sku": "IDROMAT-001",
      "mpn": "IDROMAT-001",
      "category": "Pump Control Systems",
      "image": [
        "/img/IDROMAT-Regulador-electronico-para-bombas.png.webp"
      ],
      "offers": {
        "@type": "Offer",
        "url": "https://bombasellos.com.mx/idromat-regulador-electronico-para-bombas",
        "priceCurrency": "MXN",
        "price": "4500",
      ...
      "review": [
        {
          ...
          "reviewBody": "El IDROMAT ha sido una excelente adquisición para la gestión de nuestra bomba. Su funcionamiento es fiable y ha mejorado la eficiencia de nuestra instalación."
        },
        {
          "@type": "Review",
          "reviewRating": {
          ...
          "reviewBody": "Funciona bien, pero me costó un poco instalarlo al principio. Una vez en marcha, ha sido excelente."
        }
      ],
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://bombasellos.com.mx/idromat-regulador-electronico-para-bombas"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "IDROMAT Regulador electrónico para bombas",
          "item": "https://bombasellos.com.mx/idromat-regulador-electronico-para-bombas"
        }
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Qué es el IDROMAT y para qué se utiliza?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "El IDROMAT es un dispositivo de control electrónico para bombas, diseñado para activar y desactivar la bomba automáticamente, protegiéndola de condiciones adversas como funcionamiento en seco y cierre de impulsión."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cuáles son las principales características del IDROMAT?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "El IDROMAT cuenta con un sensor de flujo y un sensor de presión, válvula de retención incorporada, y funciones de protección contra funcionamiento en seco y condiciones de alta presión."
          }
        },
        {
          "@type": "Question",
          "name": "¿Dónde puedo adquirir el IDROMAT?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "El IDROMAT está disponible para compra a través de nuestra tienda en línea o en nuestras sucursales en todo México, con disponibilidad inmediata y soporte técnico especializado."
          }
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "serviceType": "Venta y distribución de reguladores electrónicos para bombas",
      "provider": {
        "@type": "Organization",
        "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)",
        "contactPoint": {
      ...
      "description": "Ofrecemos el IDROMAT, un regulador electrónico avanzado para bombas, que asegura una operación eficiente y prolongada en instalaciones de bombeo. Ideal para aplicaciones domésticas e industriales."
    }
    </script>
                                    ...
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        <div class="swiper-container">
                                            ...
                                            <figure class="m-0 block leading-[27px]">
                                                <picture decoding="async" title="IDROMAT Regulador electrónico para bombas">
                                                    <source type="image/webp" srcset="/img/IDROMAT-Regulador-electronico-para-bombas.png.webp" /> 
                                                    <img decoding="async" src="/img/IDROMAT-Regulador-electronico-para-bombas.png.webp" alt="IDROMAT Regulador electrónico para bombas" class="max-w-full h-auto align-middle border-none shadow-none" />
                                                </picture>
                                            </figure>
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-gray-600 leading-[27px] mb-[32px] mt-0 font-bold">Ejecución</p>
            <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                Dispositivo para el control de electrobombas, dotado de un sensor de caudal y de un sensor de presión
                conexionados a un sistema electrónico. Orificios de entrada y salida del mismo diámetro (G1). Con válvula de
                retención incorporada. Manómetro 0-10 bar de serie para todos los modelos. Función de <span class="font-bold">RESET</span>
                automático para restablecer el funcionamiento sin la intervención manual para <span class="font-bold">IDROMAT</span> 4.
            </p>
            <p class="text-gray-600 leading-[27px] mb-[32px] mt-0 font-bold">Aplicaciones</p>
            <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                Para el control automático de bombas para el suministro y aumento de la presión de agua. Controla el arranque
                de la bomba a la apertura del suministro y la desconecta al cierre.
            </p>
            <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                Protege la bomba:
                <br>–Contra el funcionamiento en seco;
                <br>–Contra el funcionamiento con falta de agua en la aspiración (por falta de agua en el conducto de llegada
                estando la bomba en carga, por el tubo aspirante no sumergido o una altura de aspiración excesiva, por entrada de
                aire en la aspiración).
                <br>–Contra el funcionamiento con la impulsión cerrada.
            </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">IDROMAT</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Regulador electrónico para bombas
                                            </div>
                                        </div>
                                    </h1>
                                </div>
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/ES%20-%20Espa%C3%B1ol/DIVISI/IDROMAT_ES.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar<br />Catálogo 50 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/IDROMAT_60Hz2023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Catálogo<br/>60 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/ISTRUZIONI/IST%20IDROMAT5_6%2009_2017.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Instrucciones</a>
                                                        </p>
                                                    </div>
                                                </div>
