...
@section('title', '	
Bomba Centrífuga presurizadora líquidos limpios|Calpeda MGP')
@section('description', '	
Cotiza Bombas Centrífugas presurizadoras de líquidos limpios Calpeda MGP 
En acero inoxidable, fundición y plástico. Entrega inmediata y Precio Mayorista')
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bomba Centrífuga presurizadora de líquidos limpios Calpeda MGP",
      "description": "Cotiza Bombas Centrífugas presurizadoras de líquidos limpios Calpeda MGP en acero inoxidable, fundición y plástico. Entrega inmediata y Precio Mayorista.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      ...
      "mpn": "MGP-001",
      "image": [
        "/img/Bombas-multicelulares-horizontales-monobloc-MGP-2.png",
        "/img/curve_MGP-1024x506.jpg.webp"
      ],
      "offers": {
        "@type": "Offer",
      ...
      "review": [
        {
          ...
          "reviewBody": "La bomba funciona perfectamente para aplicaciones industriales, fácil de instalar y de bajo mantenimiento."
        },
        {
          "@type": "Review",
          "reviewRating": {
          ...
          "reviewBody": "Buena bomba, aunque podría ser más silenciosa. Sin embargo, cumple con su función."
        }
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 5,
          "name": "Bomba MGP – Bombas multicelulares horizontales monobloc",
          "item": "https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/"
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Para qué aplicaciones es ideal la bomba MGP?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La bomba MGP es ideal para aplicaciones de presurización de líquidos limpios en entornos industriales y civiles, incluyendo sistemas HVAC y sistemas de recirculación."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cuál es el rango de operación de la bomba MGP?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La bomba MGP puede manejar un caudal máximo de 7.2 m³/h y una altura máxima de 40 m, con opciones de motores trifásicos y monofásicos."
          }
        },
        {
          "@type": "Question",
          "name": "¿Ofrecen soporte técnico para la instalación de la bomba MGP?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sí, ofrecemos soporte técnico especializado para la selección e instalación de la bomba MGP. Contáctanos a través de nuestro sitio web o al +52-55-5752-1715."
          }
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "serviceType": "Venta e instalación de bombas centrífugas",
      "provider": {
        "@type": "Organization",
        "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)"
      },
      "description": "Ofrecemos servicios de venta, selección, instalación y mantenimiento de bombas centrífugas para presurización de líquidos limpios en aplicaciones industriales y civiles. Soporte técnico especializado y entrega inmediata."
    }
    </script>
                        ...
                        <div class="relative z-20 box-border">
                            <div class="bg-transparent box-border">
                                <ul class="bg-transparent m-0 p-0 inline-flex list-none flex-wrap rounded-lg box-border">
                                    ...
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto">Bomba MGP – Bombas multicelulares horizontales monobloc</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="max-w-[1190px] mx-auto flex flex-col lg:flex-row">
                            ...
                            <div class="w-full">
                                <div class="transition-all duration-300">
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        ...
                                        <div class="box-border lg:p-[10px] flex relative w-full flex-wrap content-start">
                                            <div data-id="70dd5e6" data-element_type="widget" class="relative w-full flex flex-row flex-nowrap">
                                                <div class="transition-all duration-300">
                                                    <div dir="ltr" class="pb-[30px] mx-auto static overflow-hidden z-[1]">
                                                        <div aria-live="off" class="box-content transform-none relative w-full h-[489.047px] z-[1] flex transition-transform">
                                                            <div role="group" aria-roledescription="slide" aria-label="1 de 1" class="box-border flex-shrink-0 w-full h-[489.047px] relative max-w-full text-center">
                                                                <figure class="m-0 block box-border leading-[23px]">
                                                                    <picture decoding="async" title="Bomba MGP - Bombas multicelulares horizontales monobloc 1" class="box-border">
                                                                        <source type="image/webp" srcset="/img/Bombas-multicelulares-horizontales-monobloc-MGP-2.png.webp" class="box-border" />
                                                                        <img alt="Bomba horizontal de aspiración axial Calpeda MGP" src="/img/Bombas-multicelulares-horizontales-monobloc-MGP-2.png" decoding="async" class="max-w-full h-auto align-middle border-none box-border" />
                                                                    </picture>
                                                                </figure>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="leading-[23px] mb-[32px] mt-0 box-border text-[#666666]">
                                                        Bomba de hierro multicelular monobloc para agua sin contenidos sólidos.
                                                    </p>
                                                    
                                                    <ul class="list-disc pl-4">
                                                        <li class="text-left">Eje en acero inoxidable AISI 430.</li>
                                                        <li class="text-left">Impulsor en Noryl.</li>
                                                        <li class="text-left">Motores trifásicos 230/400 V o monofásico 230 V.</li>
                                                        <li class="text-left">Qmax. 7.2 m³/h.</li>
                                                        <li class="text-left">Hmax. 40 m.</li>
                                                    </ul>
                    ...
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex flex-col lg:flex-wrap content-start">
                        <div class="relative w-full">
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas Multicelulares Horizontales.
                                            </div>
                                        </div>
                                    </h1>                                     
                                </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:mt-[80px] my-[75px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    <div data-id="7ce4ff1" data-element_type="widget" data-widget_type="image.default" class="box-border text-center w-full flex-row flex-nowrap relative">
                                        <div class="transition-all duration-300">
                                            <a href="/img/curve_MGP-1024x506.jpg.webp" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="curve_GQS-GQV" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjAyMywidXJsIjoiaHR0cHM6XC9cL2JvbWJhc2VsbG9zLmNvbS5teFwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyMFwvMDRcL2N1cnZlX0dRUy1HUVYuanBnIn0%3D" class="text-[#007bff] no-underline bg-transparent inline-block shadow-none">
                                                <picture fetchpriority="high" decoding="async" title="Bombas multicelulares MGP" class="box-border">
                                                    <source type="image/webp" sizes="(max-width: 929px) 100vw, 929px" srcset="/img/curve_MGP-1024x506.jpg.webp 929w, /img/curve_MGP-1024x506.jpg.webp 300w, /img/curve_MGP-1024x506.jpg.webp 768w" />
                                                    <img fetchpriority="high" width="929" height="549" alt="curve GQS GQV" sizes="(max-width: 929px) 100vw, 929px" srcset="/img/curve_MGP-1024x506.jpg.webp 929w, /img/curve_MGP-1024x506.jpg.webp 300w, /img/curve_MGP-1024x506.jpg.webp 768w" class="max-w-full h-auto align-middle border-none inline-block" />
                                                </picture>
                                            </a>
                                        </div>
                                    </div>
