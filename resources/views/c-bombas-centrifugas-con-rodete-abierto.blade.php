...
@section('title', 'Bombas centrífugas monobloc con rodete abierto - C CALPEDA')
@section('description', 'Bombas centrífugas monobloc con rodete abierto - C CALPEDA. Entrega Inmediata 
Marca Italiana. Distribuidor y Precioc Mayorista Mx. Refacciones y Mantenimiento')
<style>
    .swiper-container {
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Bombas centrífugas monobloc con rodete abierto - C CALPEDA",
  "description": "Bombas centrífugas monobloc con rodete abierto CALPEDA, ideales para aplicaciones industriales y agrícolas. Refacciones y mantenimiento disponibles.",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
  ...
  "image": [
    "/img/Bombas-centrifugas-con-rodete-abierto-1.png.webp",
    "/img/Bombas-centrifugas-con-rodete-abierto-2.png.webp"
  ],
  "offers": {
    "@type": "Offer",
    "url": "https://bombasellos.com.mx/bombas/c-calpeda",
    "priceCurrency": "MXN",
    "price": "42000",
  ...
  "review": [
    {
      ...
      "reviewBody": "Bomba de alta calidad, ideal para la industria agrícola. Fácil de instalar y mantiene un excelente rendimiento."
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "Buena bomba, aunque me tomó tiempo entender bien el manual de instalación."
    }
  ],
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://bombasellos.com.mx/bombas/c-calpeda"
  }
}
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Bombas centrífugas C",
      "item": "https://bombasellos.com.mx/bombas/c-calpeda"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Para qué sirven las bombas centrífugas C CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Estas bombas son ideales para aplicaciones industriales, agrícolas y civiles que requieren manejo de líquidos con impurezas moderadas."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "La entrega es inmediata si el producto está disponible en stock."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)",
  "description": "Distribuidor y servicio de mantenimiento de bombas industriales en México.",
  "telephone": "+52-55-5752-1715",
  "email": "bsh@bombasellos.com.mx",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Otavalo número 91, Colonia Lindavista",
    "addressLocality": "Delegación Gustavo A. Madero",
    "addressRegion": "CDMX",
    "postalCode": "07300",
    "addressCountry": "MX"
  }
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/C-Bombas-centrifugas-con-rodete-abierto-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/C-Bombas-centrifugas-con-rodete-abierto-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                            
                                                    <!-- Slide 3 -->
                                                    <div class="swiper-slide">
                                                        <img src="/img/C-Bombas-centrifugas-con-rodete-abierto-3.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                                    </div>
                                            </div>
                                            <!-- Add Pagination -->
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-gray-600 leading-[27px] mb-8 mt-0 font-bold">Ejecución</p>
                                                    <p class="text-gray-600 leading-[27px] mb-8 mt-0">Electrobomba centrífuga monobloc con rodete abierto.</p>
                                                    <p class="text-gray-600 leading-[27px] mb-8 mt-0">Rodete tipo vortex para tipo C 16/1E.C: Ejecución con cuerpo bomba y acoplamiento en hierro.<br/>B-C: Ejecución con cuerpo bomba y acoplamiento en bronce. Las bombas en bronce se suministran totalmente pintadas.</p>
                                                    <p class="text-gray-600 leading-[27px] mb-8 mt-0 font-bold">Aplicaciones</p>
                                                    <p class="text-gray-600 leading-[27px] mb-8 mt-0">– Para líquidos moderadamente cargados de impurezas o emulsionados. - Para la industria y la agricultura.</p>
                                                  </div>
                                                 ...
                                                 <div data-id="030d56e" class="box-border mb-5 relative w-full flex flex-nowrap">
                                                    <div class="box-border overflow-hidden transition-all duration-300 ease-in-out transform">
                                                        <div class="aspect-w-16 aspect-h-9">
                                                            <iframe width="560" height="315" src="https://www.youtube.com/embed/z_AISoBTYI4?si=l15Aq2gZ283n6GHT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div data-id="6abdc77" class="box-border mb-5 relative w-full flex flex-nowrap">
                                                    <div class="box-border overflow-hidden transition-all duration-300 ease-in-out transform">
                                                        <div class="aspect-w-16 aspect-h-9">
                                                            <iframe width="560" height="315" src="https://www.youtube.com/embed/LfAEceEhTOk?si=k4nuc8OYvs1BVRlC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">C</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas centrifugas con rodete abierto
                                            </div>
                                        </div>
                                    </h1>
                                </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:mt-[180px] mx-0 p-2.5 flex w-full flex-wrap content-start">
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    <div data-id="7ce4ff1" data-element_type="widget" data-widget_type="image.default" class="box-border text-center w-full flex-row flex-nowrap relative">
                                        <div class="transition-all duration-300">
                                                <img fetchpriority="high" width="1024" height="593" alt="C curve" sizes="(max-width: 1024px) 100vw, 1024px" title="CURVE C" nitro-lazy-srcset="/img/curve_C.jpg (1).webp 1024w, /img/curve_C.jpg (1).webp 300w, /img/curve_C.jpg (1).webp 768w, /img/curve_C.jpg (1).webp 1536w, /img/curve_C.jpg (1).webp 1876w" nitro-lazy-src="/img/curve_C.jpg (1).webp" decoding="async" nitro-lazy-empty="" src="/img/curve_C.jpg (1).webp" srcset="/img/curve_C.jpg (1).webp 1024w, /img/curve_C.jpg (1).webp 300w, /img/curve_C.jpg (1).webp 768w, /img/curve_C.jpg (1).webp 1536w, /img/curve_C.jpg (1).webp 1876w" class="max-w-full h-auto align-middle border-none box-border inline-block border-0 rounded-none shadow-none" />
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/EN%20-%20English/datasheet_EN/C_EN_012023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar<br />Catálogo 50 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/C_60Hz2023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Catálogo<br/>60 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/ISTRUZIONI/IST%20NM-NMD-C%20Rev26_11_2021.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">
