...
@section('title', 'CS CS-R.FK-Bombas sumergibles de acero inoxidable para pozos')
@section('description', 'CS CS-R.FK-Bombas sumergibles de acero inoxidable para pozos CALPEDA. Entrega Inmediata. 
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "CS CS-R.FK Bombas sumergibles de acero inoxidable para pozos",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      "description": "Bombas sumergibles de acero inoxidable CS CS-R.FK para pozos, ideales para aplicaciones en obra civil, industria y riego agrícola. Disponibilidad inmediata con soporte técnico especializado.",
      "sku": "CS-CS-R-FK-001",
      "mpn": "CS-R-FK-001",
      "category": "Industrial Pumps",
      "image": [
        "/img/CS-CS-R-FK-Motores-sumergidos-1.png.webp",
        "/img/CS-CS-R-FK-Motores-sumergidos-2.png.webp",
        "/img/CS-CS-R-FK-Motores-sumergidos-3.png.webp",
        "/img/CS-CS-R-FK-Motores-sumergidos-4.png.webp"
      ],
      "offers": {
        "@type": "Offer",
        "url": "https://bombasellos.com.mx/cs-cs-r-fk-bombas-sumergibles",
        "priceCurrency": "MXN",
        "price": "95000",
      ...
      "review": [
        {
          ...
          "reviewBody": "Excelente rendimiento y durabilidad, ideal para pozos profundos."
        },
        {
          "@type": "Review",
          "reviewRating": {
          ...
          "reviewBody": "Muy buen producto, aunque un poco costoso."
        }
      ],
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://bombasellos.com.mx/cs-cs-r-fk-bombas-sumergibles"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://bombasellos.com.mx/cs-cs-r-fk-bombas-sumergibles"
        }
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Qué características tienen las bombas sumergibles CS CS-R.FK?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Las bombas sumergibles CS CS-R.FK están diseñadas para pozos de 6” y 8”, fabricadas en acero inoxidable AISI 304 y AISI 316, con alta resistencia a la corrosión y excelentes prestaciones en ambientes exigentes."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cuáles son las aplicaciones principales de las bombas sumergibles CS CS-R.FK?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Estas bombas son ideales para la extracción de agua en pozos profundos, sistemas de presurización, riego agrícola y aplicaciones industriales que requieren bombas de alto rendimiento y durabilidad."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cómo puedo adquirir las bombas sumergibles CS CS-R.FK?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Puedes adquirirlas directamente a través de nuestro sitio web o en nuestras sucursales en todo México, con soporte técnico especializado y opciones de financiamiento."
          }
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "serviceType": "Venta y distribución de bombas sumergibles",
      "provider": {
        "@type": "Organization",
        "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)",
        "contactPoint": {
      ...
      "description": "Ofrecemos una amplia gama de bombas sumergibles de acero inoxidable para pozos profundos, ideales para aplicaciones en obra civil, industria y riego agrícola, con soporte técnico especializado y servicio postventa."
    }
    </script>
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/CS-CS-R-FK-Motores-sumergidos-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/CS-CS-R-FK-Motores-sumergidos-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 3 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/CS-CS-R-FK-Motores-sumergidos-3.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                                </div>
                                                
                                            <!-- Slide 4 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/CS-CS-R-FK-Motores-sumergidos-4.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                                </div>
                                            <!-- Slide 5 -->
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    ...
                                                    <p class="text-gray-600 leading-[27px] mb-8 mt-0">
                                                        Los motores sumergidos 4/6/8/10″ Calpeda están realizados con tecnologías de vanguardia y componentes de calidad superior, que aseguran una resistencia mecánica óptima y una fiabilidad eléctrica excelente. El buen rendimiento está también garantizado gracias a las pruebas rigurosas a las que están sometidos todos los componentes durante las diversas fases de fabricación.
                                                    </p>
                                                    <p class="text-gray-600 leading-[27px] mb-8 mt-0">
                                                        Motor sumergido rebobinable serie Cs. Los motores 4″ tienen un fluido dieléctrico especial de tipo alimentación que garantiza un mayor efecto lubricante aumentando la duración de todas las partes en movimiento y de los cables de cobre. Los motores 6″, 8″ y 10″ se hallan en baño de agua, y los cables están revestidos con cloruro de polivinilo. Todos los motores Calpeda cumplen con la normativa <span class="box-border">NEMA</span>. CS: Ejecución estándar. I-CS: Ejecución en 1.4401 (<span class="box-border">AISI</span> 316).
                                                    </p>
                                                    <p class="text-gray-600 leading-[27px] mb-8 mt-0">
                                                        Motor sumergido encapsulado serie FK. El motor de la serie FK tiene el estator herméticamente sellado e impregnado en resina especial ignífuga. Tiene una óptima eficiencia energética y una construcción en baño de agua contra el peligro de contaminación. Los cojinetes axiales y radiales lubricados en agua permiten la no intervención en mantenimientos. La compensación de presiones en el interior del motor está asegurada por una membrana especial. Para facilitar la conexión está provisto de cable de alimentación extraíble “Water Bloc”. Protección antiarena y sello mecánico sic para permitir presencia de arena con un óptimo funcionamiento. <br class="box-border" />FK: Ejecución estándar. I-FK: Ejecución en 1.4401 (<span class="box-border">AISI</span> 316).
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">CS, CS-R. FK</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas sumergibles de acero inoxidable para pozos de 6” y 8”</div>
                                        </div>
                                    </h1>
                                </div>
                            </div>
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/ES%20-%20Espa%C3%B1ol/DIVISI/CS-R_ES.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar<br />Catálogo 50 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/CS_60Hz2023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Catálogo<br/>60 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/ISTRUZIONI/IST%20CSR%206-8-10_996584A_0323.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Instrucciones</a>
                                                        </p>
                                                    </div>
                                                </div>
