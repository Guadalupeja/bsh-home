...
@section('title', '
Bombas Sumergibles de Pozo de 4 a 10 pulgadas| Calpeda® MX')
@section('description', '
Cotiza Bombas Sumergibles de Pozo en todas las Metalurgias. 
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Bombas Sumergibles de Pozo de 4 a 10 pulgadas| Calpeda® MX",
  "description": "Cotiza Bombas Sumergibles de Pozo en todas las Metalurgias. Entrega Inmediata. Marca Premium Italiana. Distribuidor Mayorista. Refacciones y Mantenimiento.",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
                ...
                <div class="bg-transparent mb-0 box-border">
                    <div class="box-border">
                        <ul class="bg-transparent m-0 p-0 inline-flex mb-0 list-none flex-wrap rounded-lg mt-0 box-border">
                            ...
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto"><span class="text-[#043e81] px-1">/</span></li>
                            <li>
                                <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-calpeda-agricultura-y-riego') }}" class="text-[#043e81] hyphens-auto no-underline bg-transparent box-shadow-none">Bombas Calpeda – Bombas para alimentación de sistemas de riego.</a>
                            </li>
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto"><span class="text-[#043e81] px-1">/</span></li>
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto">Bombas de Pozo Calpeda</li>
                        </ul>
    ...
    <div class="w-full md:w-3/4 flex flex-wrap px-1 py-0 mx-auto">
     ...
     <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
         <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
             <div class="box-border transition-all ease-in-out group">
                 <div class="box-border block relative z-10 overflow-hidden text-center">
                    <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-sumergibles-multicelulares-para-agua-limpia-mps') }}">
                        <picture fetchpriority="high" decoding="async" title="Bombas de Pozo Calpeda 1" class="box-border">
                             <source type="image/webp" srcset="/img/Bombas-sumergibles-multicelulares-para-agua-limpia-MPS.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                             <img fetchpriority="high" decoding="async" width="300" height="490" src="/img/Bombas-sumergibles-multicelulares-para-agua-limpia-MPS.png" alt="Bomba de pozo profundo de 4&quot;, 5&quot;, 6&quot;,8&quot;,10&quot; de SS 316." srcset="/img/Bombas-sumergibles-multicelulares-para-agua-limpia-MPS.png 300w, /img/Bombas-sumergibles-multicelulares-para-agua-limpia-MPS-184x300.png 184w" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                         </picture>
                     </a>
                 </div>
             </div>
             ...
             <div class="box-border transition-all ease-in-out">
                 <div>
                     <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                         <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-sumergibles-multicelulares-para-agua-limpia-mps') }}" class="text-[#007bff] no-underline bg-transparent">
                             <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bombas MPS</span>
                         </a>
                     </h2>
                 </div>
             </div>
         ...
         <div class="relative w-full text-left flex flex-row justify-center">
             <div class="box-border m-0 transition-all ease-in-out">
                 <div>
                     <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-sumergibles-multicelulares-para-agua-limpia-mps') }}" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
     ...
     <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
         <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
             <div class="box-border transition-all ease-in-out group">
                 <div class="box-border block relative z-10 overflow-hidden text-center">
                     <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/mxs-bombas-sumergibles-multicelulares-para-agua-limpia') }}">
                         <picture decoding="async" title="Bombas de Pozo Calpeda 2" class="box-border">
                             <source type="image/webp" srcset="/img/MXS.png.webp 300w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                             <img decoding="async" width="300" height="490" src="/img/MXS.png" alt="Bomba de pozo profundo de 4&quot;, 5&quot;, 6&quot;,8&quot;,10&quot; de SS 316." srcset="/img/MXS.png 300w, /img/MXS-184x300.png 184w" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                         </picture>
                     </a>
                 </div>
             </div>
         ...
         <div class="mb-2 relative w-full flex flex-row justify-center">
             <div class="box-border transition-all ease-in-out">
                 <div>
                     <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                         <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/mxs-bombas-sumergibles-multicelulares-para-agua-limpia') }}" class="text-[#007bff] no-underline bg-transparent">
                             <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bombas MXS</span>
                         </a>
                     </h2>
                 </div>
             </div>
         ...
         <div class="relative w-full text-left flex flex-row justify-center">
             <div class="box-border m-0 transition-all ease-in-out">
                 <div>
                     <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/mxs-bombas-sumergibles-multicelulares-para-agua-limpia') }}" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                         <span class="flex justify-center">
                             <span class="mr-1 order-5 flex-grow-0">
                                 <i class="fas fa-plus text-white py-3"></i>
                             </span>
     ...
     <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
         <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
             <div class="box-border transition-all ease-in-out group">
                 <div class="box-border block relative z-10 overflow-hidden text-center">
                     <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/sd-bombas-sumergibles-para-pozos-de-4-y-6') }}">
                         <picture loading="lazy" decoding="async" title="Bombas de Pozo Calpeda 3" class="box-border">
                             <source type="image/webp" srcset="/img/SD.png.webp 300w, /img/SD-184x300.png.webp 184w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                             <img loading="lazy" decoding="async" width="300" height="490" src="/img/SD.png" alt="Bomba de pozo profundo de 4&quot;, 5&quot;, 6&quot;,8&quot;,10&quot; de SS 316." srcset="/img/SD.png 300w, /img/SD-184x300.png 184w" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                         </picture>
                     </a>
                 </div>
             </div>
         ...
         <div class="mb-2 relative w-full flex flex-row justify-center">
             <div class="box-border transition-all ease-in-out">
                 <div>
                     <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                         <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/sd-bombas-sumergibles-para-pozos-de-4-y-6') }}" class="text-[#007bff] no-underline bg-transparent">
                             <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bombas SD</span>
                         </a>
                     </h2>
                 </div>
             </div>
         ...
         <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
             <div class="box-border m-0 p-0 transition-all ease-in-out">
                 <div>
                     <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bombas sumergibles para pozos de 4” y 6”</p>
                 </div>
             </div>
         </div>
         <div class="relative w-full text-left flex flex-row justify-center">
             <div class="box-border m-0 transition-all ease-in-out">
                 <div>
                     <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/sd-bombas-sumergibles-para-pozos-de-4-y-6') }}" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                         <span class="flex justify-center">
                             <span class="mr-1 order-5 flex-grow-0">
                                 <i class="fas fa-plus text-white py-3"></i>
                             </span>
     ...
     <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
         <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
             <div class="box-border transition-all ease-in-out group">
                 <div class="box-border block relative z-10 overflow-hidden text-center">
                     <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/sdx-bombas-sumergibles-de-acero-inoxidable-para-pozos-de-6-y-8') }}">
                         <picture loading="lazy" decoding="async" title="Bombas de Pozo Calpeda 4" class="box-border">
                             <source type="image/webp" srcset="/img/bomba-sdx-calpeda.png.webp 300w, /img/bomba-sdx-calpeda-184x300.png.webp 184w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                             <img loading="lazy" decoding="async" width="300" height="490" src="/img/bomba-sdx-calpeda.png" alt="Bomba de pozo profundo de 4&quot;, 5&quot;, 6&quot;,8&quot;,10&quot; de SS 316." srcset="/img/bomba-sdx-calpeda.png 300w, /img/bomba-sdx-calpeda-184x300.png 184w" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                         </picture>
                     </a>
                 </div>
             </div>
         ...
         <div class="mb-2 relative w-full flex flex-row justify-center">
             <div class="box-border transition-all ease-in-out">
                 <div>
                     <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                         <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/sdx-bombas-sumergibles-de-acero-inoxidable-para-pozos-de-6-y-8') }}" class="text-[#007bff] no-underline bg-transparent">
                             <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bombas SDX</span>
                         </a>
                     </h2>
                 </div>
             </div>
         ...
         <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
             <div class="box-border m-0 p-0 transition-all ease-in-out">
                 <div>
                     <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bombas sumergibles de acero inoxidable para pozos de 6” y 8”</p>
                 </div>
             </div>
         </div>
         <div class="relative w-full text-left flex flex-row justify-center">
             <div class="box-border m-0 transition-all ease-in-out">
                 <div>
                     <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/sdx-bombas-sumergibles-de-acero-inoxidable-para-pozos-de-6-y-8') }}" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                         <span class="flex justify-center">
                             <span class="mr-1 order-5 flex-grow-0">
                                 <i class="fas fa-plus text-white py-3"></i>
                             </span>
     ...
     <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
         <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
             <div class="box-border transition-all ease-in-out group">
                 <div class="box-border block relative z-10 overflow-hidden text-center">
                     <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/sds-bombas-sumergibles-para-pozos-de-6-8-y-10') }}">
                         <picture loading="lazy" decoding="async" title="Bombas de Pozo Calpeda 5" class="box-border">
                             <source type="image/webp" srcset="/img/bomba-sds-calpeda.png.webp 300w, /img/bomba-sds-calpeda-184x300.png.webp 184w" sizes="(max-width: 300px) 100vw, 300px" class="box-border" />
                             <img loading="lazy" decoding="async" width="300" height="490" src="/img/bomba-sds-calpeda.png" alt="Bomba de pozo profundo de 4&quot;, 5&quot;, 6&quot;,8&quot;,10&quot; de SS 316." srcset="/img/bomba-sds-calpeda.png 300w, /img/bomba-sds-calpeda-184x300.png 184w" sizes="(max-width: 300px) 100vw, 300px" class="max-w-full h-auto align-middle border-none p-0 m-0 transition-transform ease-in-out transform group-hover:translate-x-2" />
                         </picture>
                     </a>
                 </div>
             </div>
         ...
         <div class="mb-2 relative w-full flex flex-row justify-center">
             <div class="box-border transition-all ease-in-out">
                 <div>
                     <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                         <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/sds-bombas-sumergibles-para-pozos-de-6-8-y-10') }}" class="text-[#007bff] no-underline bg-transparent">
                             <span class="font-roboto font-semibold text-[#043e81] border-[#6ec1e4] inline-flex border-none">Bombas SDS</span>
                         </a>
                     </h2>
                 </div>
             </div>
         ...
         <div class="text-[#7a7a7a] font-roboto font-normal mb-2 text-[12px] relative w-full flex flex-row h-10 justify-center">
             <div class="box-border m-0 p-0 transition-all ease-in-out">
                 <div>
                     <p class="text-[#666666] leading-[21.6px] mb-2 mt-0">Bombas sumergibles para pozos de 6”, 8” y 10”</p>
                 </div>
             </div>
         </div>
         <div class="relative w-full text-left flex flex-row justify-center">
