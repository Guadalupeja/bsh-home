...
@section('title', 'Bombas Sumergibles con Impulsor Vortex | Calpeda(R) GX40')
@section('description', 'Cotiza Bombas sumergibles GX 40 para lodos y líquidos con sólidos de gran tamaño. 
Selección, Instalación, Mantenimiento y Refacciones. Distribuidor Mayorista.')
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Bomba Sumergible con Impulsor Vortex | Calpeda GX40",
  "description": "Cotiza bombas sumergibles Calpeda GX40 para líquidos con sólidos de gran tamaño y lodos. Selección, instalación, mantenimiento y refacciones. Distribuidor Mayorista.",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
  ...
  "mpn": "GX40-001",
  "image": [
    "/img/Bombas-sumergibles-de-acero-inoxidable-para-aguas-sucias-GX40.png.webp",
    "/img/curve_GX_40-1024x504.jpg.webp"
  ],
  "offers": {
    "@type": "Offer",
    "url": "https://bombasellos.com.mx/bombas/bombas-sumergibles-calpeda/gx40",
    "priceCurrency": "MXN",
    "price": "12500",
  ...
  "review": [
    {
      ...
      "reviewBody": "Excelente bomba sumergible, ideal para uso en lodos y aguas con sólidos. Muy resistente y fácil de mantener."
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Bomba Sumergible GX40",
      "item": "https://bombasellos.com.mx/bombas/bombas-sumergibles-calpeda/gx40"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Para qué aplicaciones es adecuada la bomba sumergible GX40?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "La bomba sumergible GX40 es ideal para el manejo de líquidos con sólidos y lodos en aplicaciones industriales, agrícolas y de obra civil, como drenaje y tratamiento de aguas."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cómo puedo obtener más información sobre la bomba GX40?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Puedes obtener más información contactando a nuestros expertos a través de nuestro formulario en línea o llamando al +52-55-5752-1715."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Service",
  "serviceType": "Selección e instalación de bombas sumergibles",
  "provider": {
    "@type": "Organization",
    "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)"
  },
  "description": "Ofrecemos servicios de selección, instalación y mantenimiento de bombas sumergibles para aplicaciones industriales, agrícolas y civiles. Soporte técnico especializado."
}
</script>
                        ...
                        <div class="relative z-20 box-border">
                            <div class="bg-transparent box-border">
                                <ul class="bg-transparent m-0 p-0 inline-flex list-none flex-wrap rounded-lg box-border">
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><a href="{{ url('/') }}" class="text-[#043E81] no-underline box-shadow-none">Home</a></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><a href="{{ url('/bombas') }}" class="text-[#043E81] no-underline box-shadow-none">Bombas</a></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><a href="{{ url('/bombas/bombas-centrifugas-calpeda') }}" class="text-[#043E81] no-underline box-shadow-none">Centrífugas Calpeda</a></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica') }}" class="text-[#043E81] no-underline box-shadow-none">Bombas para obra civil y urbanística</a></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-drenaje-y-tratamiento-de-aguas') }}" class="text-[#043E81] no-underline box-shadow-none">
                                        Bombas Calpeda – Drenaje y tratamiento de aguas.
                                        </a></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto"><span class="text-[#043E81] px-1">/</span></li>
                                    <li class="block text-[#043E81] text-[16px] font-normal text-left box-border font-roboto">Bombas sumergibles de acero inoxidable para aguas sucias – GX40</li>
                                </ul>                                
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div aria-live="off" class="box-border transform translate-x-0 relative w-full h-[489.047px] z-[1] flex transition-transform">
                                                            <div role="group" aria-roledescription="slide" aria-label="1 de 1" class="box-border flex-shrink-0 w-full h-[489.047px] relative max-w-full text-center">
                                                                <figure class="m-0 block box-border leading-[23px]">
                                                                    <picture decoding="async" title="Bomba Sumergible GX 40" class="box-border">
                                                                        <source type="image/webp" srcset="/img/Bombas-sumergibles-de-acero-inoxidable-para-aguas-sucias-GX40.png.webp" />
                                                                        <img alt="Bombas Calpeda sumergibles GX40" src="/img/Bombas-sumergibles-de-acero-inoxidable-para-aguas-sucias-GX40.png.webp" decoding="async" class="max-w-full h-auto align-middle border-none box-border shadow-none" />
                                                                    </picture>
                                                                </figure>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="leading-[23px] mb-[32px] mt-0 box-border text-[#666666]">
                                                        Bomba sumergible construida en acero inoxidable AISI 304, 
                                                        con impulsor tipo vortex. Para agua con contenidos sólidos de hasta 35 mm de diámetro.
                                                     </p>
                                                     <p class="leading-[23px] mb-[32px] mt-0 box-border text-[#666666]">
                                                        Muy usada en la industria alimentaria por su sello mecanico doble 
                                                        y su superficie de acero inoxidable laminado.
                                                     </p>
                                                    
                                                     <ul class="list-disc pl-4">
                                                        <li>Cuerpo camisa y eje en acero inoxidable AISI 304.</li>
                                                        <li>Asa de transporte.</li>
                                                        <li>Aceite blanco y sello mecánico doble para aplicaciones sanitarias.</li>
                                                        <li>Motores trifásicos 230/400 V o monofásico 230 V.</li>
                                                        <li>Incluye cable de 10 m.</li>
                        ...
                        <div class="relative w-full">
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <p class="leading-[23px] mb-[32px] mt-2 text-justify text-[#666666] box-border">
                                        Bombas Sumergibles de acero inoxidable 
                                        al níquel-cromo, con boca de impulsión vertical e Impulsor Vortex.
                                      </p>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:mt-[240px] my-[45px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    <div class="box-border text-center relative w-full flex flex-row flex-nowrap justify-normal items-normal">
                                        <div class="box-border transition-all duration-300">
                                            <a href="/img/curve_GX_40-1024x504.jpg.webp" 
                                               data-elementor-open-lightbox="yes" 
                                               data-elementor-lightbox-title="curve_GQR" 
                                               data-elementor-lightbox-description="Rango operativo bomba GX 40" 
                                               data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjAwMywidXJsIjoiaHR0cHM6XC9cL2JvbWJhc2VsbG9zLmNvbS5teFwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyMFwvMDRcL2N1cnZlX0dRUi5qcGcifQ%3D%3D" 
                                               class="text-blue-600 no-underline bg-transparent inline-block box-shadow-none">
                                                <picture fetchpriority="high" decoding="async" title="Bomba sumergible GX40" class="box-border">
                                                    <source type="image/webp" sizes="(max-width: 941px) 100vw, 941px" srcset="/img/curve_GX_40-1024x504.jpg.webp 941w, /img/curve_GX_40-1024x504.jpg.webp 300w, /img/curve_GX_40-1024x504.jpg.webp 768w" />
                                                    <img fetchpriority="high" width="941" height="542" alt="Rango operativo bomba sumergible GX40" sizes="(max-width: 941px) 100vw, 941px" src="/img/curve_GX_40-1024x504.jpg.webp" class="max-w-full h-auto align-middle border-none inline-block box-shadow-none" />
                                                </picture>
                                            </a>
                                        </div>
                                    </div>
