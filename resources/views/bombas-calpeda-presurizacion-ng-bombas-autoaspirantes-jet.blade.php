...
@section('title', 'Bombas Autocebantes con inyector Jet para lavado| Calpeda NG')
@section('description', 'Cotiza aquí Bombas autocebantes con inyector jet para lavado a presión. Entrega inmediata Precios Distribuidor Mayorista Calpeda Envíos todo MX Marca Premium')
<style>
  .swiper-container {
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bombas Autocebantes con inyector Jet - Calpeda NG",
      "description": "Bombas autocebantes con inyector jet para lavado a presión, fabricadas por la marca premium italiana Calpeda. Disponibles con entrega inmediata a precios de distribuidor mayorista. Ideales para aplicaciones industriales y de lavado a presión.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      ...
      "mpn": "NG-12345",
      "image": [
        "/img/NG-Bombas-autoaspirantes-jet-1.png.webp",
        "/img/NG-Bombas-autoaspirantes-jet-2.png.webp"
      ],
      "offers": {
        "@type": "AggregateOffer",
      ...
      "review": [
        {
          ...
          "reviewBody": "Excelente bomba para lavado a presión, muy eficiente y robusta."
        }
      ],
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://bombasellos.com.mx/bombas-autoaspirantes-jet-calpeda-ng"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 4,
          "name": "Bombas Autocebantes con inyector Jet",
          "item": "https://bombasellos.com.mx/bombas-autoaspirantes-jet-calpeda-ng"
        }
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Qué son las bombas autocebantes con inyector Jet Calpeda NG?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Las bombas autocebantes con inyector Jet Calpeda NG son diseñadas para aplicaciones industriales, específicamente para lavado a presión y suministro de agua limpia."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cuáles son las aplicaciones principales de las bombas Calpeda NG?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Estas bombas son ideales para lavado a presión en la industria, sistemas de riego, y otras aplicaciones que requieren suministro de agua limpia con alta presión."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cómo puedo comprar una bomba Calpeda NG?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Puedes comprar una bomba Calpeda NG directamente a través de nuestro sitio web o contactando con nuestro equipo de ventas para recibir asesoría personalizada."
          }
        }
      ]
    }
...
<div class="box-border p-2.5 flex flex-col relative w-full content-start mx-auto lg:w-[90%] lg:flex-row lg:ml-[120.5px]">
    ...
    <div class="lg:w-3/4 flex relative w-[90%] flex-wrap content-start flex-col lg:flex-row px-1 py-0 mx-auto">
        <div class="box-border p-2.5 flex flex-col lg:flex-row">
            <section class="block box-border w-full">
                <div class="max-w-[1190px] mx-auto flex flex-col lg:flex-row">
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex">
                        <div class="w-full">
                            <div class="w-full">
                                <div class="transition-all duration-300">
                                    <div dir="ltr" class="mx-auto relative overflow-hidden z-1">
                                       
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                <!-- Slide 1 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/NG-Bombas-autoaspirantes-jet-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/NG-Bombas-autoaspirantes-jet-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 3 -->
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify my-[50px]">
                                            <div class="w-full flex">
                                                        <h2 class="text-[31px] text-[#043e81] my-[50px] leading-none font-semibold font-roboto border-none">
                                                            Detalles técnicos
                                                        </h2>                                              
                                            </div>
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-[#666] leading-[27px] mb-8">
                                                        Bombas autoaspirantes “jet”; con inyector incorporado. Para suministro de agua y líquidos limpios.
                                                        <br> <br>
                                                        Ampliamente usada para aplicaciones de lavado a presión en la industria. </p>
                                                        <ul class="list-disc pl-4">
                                                        ...
                                                        <div class="relative w-full flex flex-row flex-nowrap justify-normal items-normal content-normal mb-5">
                                                            <div class="overflow-hidden transition-transform duration-300 ease-in-out">
                                                                <div class="aspect-w-16 aspect-h-9">
                                                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/jZuIW7JhAXk?si=abvo85airNn9cbPA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="relative w-full flex flex-row flex-nowrap justify-normal items-normal content-normal mb-5">
                                                            <div class="overflow-hidden transition-transform duration-300 ease-in-out">
                                                                <div class="aspect-w-16 aspect-h-9">
                                                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/9kis36QVq1U?si=zoyoIpbTMmilU18l" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex flex-wrap content-start">
                        <div class="relative w-full">
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bomba Jet NG.</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas Autocebantes con inyector Jet.  </div>
                                        </div>
                                    </h1>
                                </div>
                            </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:my-[250px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                <div class="box-border text-gray-500 font-roboto font-normal text-xs mb-2 w-full relative">
                                    <div class="transition-all">
                                        <p class="leading-[23px] mt-0 text-gray-600">
                                            <span class="text-[#043e81]">
                                                <strong class="font-bold">Campo de aplicaciones</strong>
                                            </span>
                                        </p>
                                    </div>
                                </div>
                                <div class="box-border relative flex items-center">
                                    <div class="transition-all">
                                        <a href="/img/curve_NG.jpg" class="text-blue-600 no-underline shadow-none inline-block">
                                            <picture>
                                                <source type="image/webp" sizes="(max-width: 1024px) 100vw, 1024px" srcset="/img/curve_NG-1024x519.jpg.webp 1024w, /img/curve_NG-300x152.jpg.webp 300w, /img/curve_NG-768x389.jpg.webp 768w, /img/curve_NG-600x304.jpg.webp 600w, /img/curve_NG.jpg.webp 1138w">
                                                <img src="/img/curve_NG-1024x519.jpg" alt="curve NG" class="max-w-[200px] h-auto border-none" />
                                            </picture>
                                        </a>
                                    </div>
                                </div>
