...
@section('title', 'BS Grupos de presión con bombas de velocidad fija, variable')
@section('description', 'BS Grupos de presión con bombas de velocidad fija y variable CALPEDA. Entrega Inmediata. 
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "BS Grupos de presión con bombas de velocidad fija y variable CALPEDA",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      "description": "Grupos de presión con bombas de velocidad fija y variable, ideales para aplicaciones industriales y civiles, con disponibilidad inmediata y soporte técnico especializado.",
      "sku": "BS-GROUPS-001",
      "mpn": "BS-001",
      "category": "Industrial Pumps",
      "image": [
        "/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-1.png.webp",
        "/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-2.png.webp",
        "/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-3.png.webp",
        "/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-4.png.webp",
        "/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-5.png.webp",
        "/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-6.png.webp"
      ],
      "offers": {
        "@type": "Offer",
        "url": "https://bombasellos.com.mx/bs-grupos-de-presion-con-bombas-de-velocidad-fija-y-variable",
        "priceCurrency": "MXN",
        "price": "85000",
      ...
      "review": [
        {
          ...
          "reviewBody": "Excelente grupo de presión, fácil de instalar y con un rendimiento superior."
        },
        {
          "@type": "Review",
          "reviewRating": {
          ...
          "reviewBody": "Muy buen producto, aunque el envío fue un poco lento."
        }
      ],
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://bombasellos.com.mx/bs-grupos-de-presion-con-bombas-de-velocidad-fija-y-variable"
      }
    }
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bombasellos.com.mx/bs-grupos-de-presion-con-bombas-de-velocidad-fija-y-variable"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué características tienen los grupos de presión BS?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Los grupos de presión BS cuentan con bombas de velocidad fija y variable, ideales para sistemas industriales y de obra civil. Disponibles en distintas configuraciones para ajustarse a las necesidades específicas de cada proyecto."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cuáles son las especificaciones técnicas de los grupos de presión BS?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las especificaciones técnicas varían según el modelo, pero incluyen sistemas de control avanzado, múltiples bombas para redundancia y operación continua, y materiales de alta calidad resistentes a la corrosión."
      }
    },
    {
      "@type": "Question",
      "name": "¿Dónde puedo adquirir los grupos de presión BS?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Puedes adquirirlos a través de nuestro sitio web o en nuestras sucursales en todo México, con soporte técnico especializado y opciones de financiamiento."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Service",
  "serviceType": "Venta y distribución de grupos de presión industriales",
  "provider": {
    "@type": "Organization",
    "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)",
    "contactPoint": {
  ...
  "description": "Ofrecemos una amplia gama de grupos de presión con bombas de velocidad fija y variable, ideales para aplicaciones industriales, civiles y agrícolas, con soporte técnico especializado y servicio postventa."
}
</script>
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 3 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-3.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                                </div>
                                                
                                            <!-- Slide 4 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-4.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                                </div>
                                            <!-- Slide 5 -->
                                            <div class="swiper-slide">
                                                <img src="/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-5.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                            </div>
                                            
                                            <!-- Slide 6 -->
                                            <div class="swiper-slide">
                                                <img src="/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-6.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                            </div>

                                            <!-- Slide 7 -->
                                            <div class="swiper-slide">
                                                <img src="/img/BS-Grupos-de-presion-con-bombas-de-velocidad-fija-y-variable-7.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                            </div>
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    ...
                                                    <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                                                        <span>Conjuntos de aumento de presión con bomba de velocidad fija de 1 a 6. Conjuntos con 4,5 y 6 bombas bajo pedido. Dependiendo de la reducción de la presión en el sistema, los interruptores de presión determinan el arranque de la secuencia de las bombas y el microprocesador alterna los arranques.</span>
                                                    </p>
                                                    <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                                                        <strong class="font-bold">
                                                            <span>BS1V2-5F</span>
                                                    ...
                                                    <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                                                        <span>Conjuntos de aumento de presión con 1 bomba de velocidad variable (con convertidor de frecuencia en el panel de control) y de 1 a 5 bombas de velocidad fija Conjuntos con 4,5 y 6 bombas bajo pedido. Según el consumo de agua, una o más bombas arrancan, una a velocidad variable y los otros a velocidad fija, para otorgar la cantidad de agua requerida a la presión establecida.</span>
                                                    </p>
                                                    <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                                                        <strong class="font-bold">
                                                            <span>BS1-6V</span>
                                                    ...
                                                    <p class="text-gray-600 leading-[27px] mb-[32px] mt-0">
                                                        <span>Conjuntos de aumento de presión con 1 a 6 bombas de velocidad variable (con convertidor de frecuencia en el panel de control). Conjuntos con 4,5 y 6 bombas a pedido. Dependiendo del consumo de agua, una o más bombas están activadas, todas a velocidad variable, para garantizar la cantidad de agua requerida a la presión establecida.</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">BS</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Grupos de presión con bombas de velocidad fija y variable</div>
                                        </div>
                                    </h1>
                                </div>
                            </div>
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/EN%20-%20English/datasheet_EN/BS_EN_012023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar<br />Catálogo 50 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/BS_60Hz2023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Catálogo<br/>60 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
