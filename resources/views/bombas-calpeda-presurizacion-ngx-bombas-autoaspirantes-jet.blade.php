...
@section('title', 'Bombas centrífugas autoaspirantes monobloc jet | CALPEDA NGX')
@section('description', 'Bombas centrífugas autoaspirantes monobloc jet CALPEDA NGX. Entrega Inmediata. 
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bomba centrífuga autoaspirante monobloc | Calpeda NGX",
      "description": "Bomba centrífuga autoaspirante monobloc jet NGX de Calpeda, ideal para suministro de agua y aplicaciones industriales. Disponibilidad inmediata y soporte técnico especializado.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      ...
      "image": [
        "/img/NGX-Bombas-autoaspirantes-jet-1.png.webp",
        "/img/NGX-Bombas-autoaspirantes-jet-2.png.webp",
        "/img/curve_NGX-1024x555.png"
      ],
      "offers": {
        "@type": "Offer",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 5,
          "name": "Bombas centrífugas autoaspirantes monobloc jet – NGX",
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Qué aplicaciones tiene la bomba NGX de Calpeda?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La bomba NGX de Calpeda es ideal para suministro de agua, bombeo de agua con aire o gases, y aumento de presión en redes de distribución."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cuáles son las características principales de la bomba NGX?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La bomba NGX es una centrífuga autoaspirante monobloc con inyector incorporado, diseñada para aplicaciones que requieren confiabilidad y eficiencia."
          }
        },
        {
          "@type": "Question",
          "name": "¿Dónde puedo comprar la bomba NGX de Calpeda?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Puedes comprar la bomba NGX a través de nuestro sitio web o en nuestras sucursales. Ofrecemos soporte técnico y servicio postventa."
          }
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Distribución y mantenimiento especializado de bombas industriales Calpeda, incluyendo bombas centrífugas autoaspirantes NGX."
    }
    </script>
@endsection
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/NGX-Bombas-autoaspirantes-jet-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/NGX-Bombas-autoaspirantes-jet-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                            </div>
                                            <!-- Add Pagination -->
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-gray-600 leading-7 mb-8 mt-0 box-border">
                                                        <strong class="font-bold box-border">Ejecución</strong>
                                                    </p>
                                                    <p class="text-gray-600 leading-7 mb-8 mt-0 box-border">
                                                        Bomba centrífuga autoaspirante monobloc con inyector incorporado.Una bomba para el abastecimiento de agua para uso doméstico de alta calidad y ecológica, con un cuerpo de acero inoxidable, con rotor de latón y con una mínima utilización de mate- riales plásticos.
                                                    </p>
                                                    <p class="text-gray-600 leading-7 mb-8 mt-0 box-border">
                                                        <strong class="font-bold box-border">Aplicaciones</strong>
                                                    </p>
                                                    <p class="text-gray-600 leading-7 mb-8 mt-0 box-border">
                                                        – Para suministro de agua con aspiración de pozo.- Para bombear agua que contiene aire u otras sustancias gaseosas.- Para aumentar la presión del agua que llega directamente a la bomba.- Para aumentar la presión disponible de una red de distribución (observar las disposiciones locales).- Para el jardín.- Para lavar con chorro de agua a presión.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div data-id="5e55c22" class="w-full relative flex">
                                            <div class="w-full p-2.5 flex flex-wrap relative">
                                                ...
                                                <div data-id="ada5c6c" class="w-full text-center relative flex">
                                                    <div class="transition-all duration-300 ease-in-out">
                                                        <img decoding="async" width="1024" height="555" src="/img/curve_NGX-1024x513.webp" alt="curve NGX" class="max-w-full h-auto align-middle border-none inline-block">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
