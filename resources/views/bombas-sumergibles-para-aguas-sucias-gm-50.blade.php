...
@section('title', 'Bomba sumergible tratamiento de aguas y lodos | Calpeda GM50')
@section('description', 'Bomba sumergible para el tratamiento de aguas y lodos Calpeda GM50 Entrega Inmediata. 
...
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "Bomba sumergible tratamiento de aguas y lodos - Calpeda GM50",
      "description": "Bomba sumergible Calpeda GM50 ideal para el tratamiento de aguas y lodos en aplicaciones industriales y civiles. Construcción robusta en metal y alta capacidad de manejo de sólidos.",
      "brand": {
        "@type": "Brand",
        "name": "Calpeda"
      },
      ...
      "image": [
        "/img/Bombas-sumergibles-para-aguas-sucias-GM-50-1.png.webp",
        "/img/Bombas-sumergibles-para-aguas-sucias-GM-50-2.png.webp"
      ],
      "offers": {
        "@type": "AggregateOffer",
        "url": "https://bombasellos.com.mx/bombas-sumergibles-gm-calpeda",
        "priceCurrency": "MXN",
        "lowPrice": "12000",
        "highPrice": "45000",
        "offerCount": "3",
      ...
      "review": [
        {
          ...
          "reviewBody": "Excelente desempeño en aplicaciones industriales. Recomendada para uso intensivo."
        },
        {
          "@type": "Review",
          "reviewRating": {
          ...
          "reviewBody": "Muy eficiente para manejo de lodos en la planta de tratamiento."
        }
      ],
      "mainEntityOfPage": {
        "@type": "WebPage",
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Qué aplicaciones tiene la bomba sumergible GM50?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "La bomba sumergible GM50 es ideal para plantas de tratamiento de aguas, manejo de lodos y aplicaciones industriales que requieren alta capacidad de bombeo y manejo de sólidos."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cómo puedo comprar la bomba GM50 Calpeda?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Puedes comprar la bomba GM50 Calpeda contactando a nuestro equipo de ventas en el sitio web o llamando al +52-55-5752-1715."
          }
        }
      ]
    }
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "serviceType": "Distribución y Mantenimiento de Bombas Industriales",
      "provider": {
        "@type": "Organization",
        "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)"
      },
      "description": "Somos expertos en la distribución y mantenimiento de bombas industriales de alta capacidad para tratamiento de aguas, lodos y aplicaciones industriales en México."
    }
    </script>
                ...
                <div class="bg-transparent mb-0 box-border">
                    <div class="box-border">
                        <ul class="bg-transparent m-0 p-0 inline-flex mb-0 list-none flex-wrap rounded-lg mt-0 box-border">
                            ...
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto"><span class="text-[#043e81] px-1">/</span></li>
                            <li><a href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-drenaje-y-tratamiento-de-aguas/" class="text-[#043e81] hyphens-auto no-underline bg-transparent box-shadow-none">
                                Bombas Calpeda – Drenaje y tratamiento de aguas.
                                </a></li>
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto"><span class="text-[#043e81] px-1">/</span></li>
                            <li class="block text-[#043e81] text-[16px] font-normal hyphens-auto text-left box-border font-roboto">Bombas sumergibles para aguas sucias – GM 50</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="box-border text-[#043E81] font-roboto font-normal gap-[79px] leading-[30px] mb-5 relative w-full flex flex-col gap-x-[79px] flex-grow-0 flex-shrink-1 order-0 self-auto">
            <div class="box-border transition duration-300 ease-in-out transform">
                ...
                <ul class="list-disc pl-4">
                    <li class="box-border text-left">
                        <span class="text-[#043E81] box-border">
                            <a class="text-[#043E81] no-underline box-shadow-none" href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-industria-bombas-centrifugas-monobloc-bombas-multicelulares-horizontales/tratamiento-de-aguas-residuales/">Bombas de tratamientos de aguas residuales.</a>
                        </span>
                    </li>
                    <li class="box-border text-left">
                        <span class="text-[#043E81] box-border">
                            <a class="text-[#043E81] no-underline box-shadow-none" href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-industria-bombas-centrifugas-monobloc-bombas-multicelulares-horizontales/bombas-calpeda-maquinaria-y-equipos-oem/">Maquinaria y equipos (OEM)</a>
                        </span>
                    </li>
                    <li class="box-border text-left">
                        <span class="text-[#043E81] box-border">
                            <a class="text-[#043E81] no-underline box-shadow-none" href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-para-industria-bombas-centrifugas-monobloc-bombas-multicelulares-horizontales/bombas-calpeda-circuitos-de-transferencia-de-calor-y-refrigeracion/">Bombas de alimentación a circuitos HVAC en la industria.</a>
                        </span>
                    </li>
                </ul>
                <div class="box-border">&nbsp;</div>
                ...
                <ul class="list-disc pl-4">
                    <li class="box-border text-left">
                        <span class="text-[#043E81] box-border">
                            <a class="text-[#043E81] no-underline box-shadow-none" href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-calpeda-agricultura-y-riego/">Bombas para alimentación de sistemas de riego.</a>
                        </span>
                    </li>
                    <li class="box-border text-left">
                        <span class="text-[#043E81] box-border">
                            <a class="text-[#043E81] no-underline box-shadow-none" href="https://bombasellos.com.mx/bombas/bombas-centrifugas-calpeda/bombas-calpeda-agricultura-y-riego/bombas-calpeda-bombas-sumergibles-de-pozo-profundo/">Bombas sumergibles de pozo profundo.</a>
                        </span>
                    </li>
                </ul>
            </div>
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/Bombas-sumergibles-para-aguas-sucias-GM-50-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/Bombas-sumergibles-para-aguas-sucias-GM-50-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                            </div>
                                            <!-- Add Pagination -->
                                            ...
                                            <div class="w-full">
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-[#666] leading-[27px] mb-8">
                                                        Bomba sumergible monobloc con impulsor tipo vortex para manejo de agua con contenidos 
                                                        sólidos de hasta 50 mm de diámetro en aplicaciones civiles en industriales.
                                                    </p>
                                                    <ul class="list-disc pl-4 space-y-2">
                                                        <li>Cuerpo, tapas, carcasa de motor y rodete en fundición EN 1561.</li>
                                                        <li>Eje de acero inoxidable AISI 430.</li>
                                                        <li>Aceite blanco para aplicaciones sanitarias.</li>
                                                        <li>Profundidad máxima de inmersión de 10 metros.</li>
                                                        <li>Motores trifásicos 230/400 V o monofásico 230 V.</li>
                                                        <li>Asa de transporte e interruptor de nivel ajustable.</li>
                                                        <li>Alta protección contra funcionamiento en seco.</li>
                                                        <li>Qmx. 48 m<sup>3</sup>/h</li>
                                                        <li>Hmax. 17.3 m.</li>
                                                    </ul>
                        ...
                        <div class="relative w-full">
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="lg:text-[35px] text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bomba Sumergible GM 50.</div>
                                        </div>
                                    </h1>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas sumergibles para aguas sucias y lodos. </div>
                                        </div>
                                    </h2>


                                    <p class="font-roboto text-[#5f5f5f]  border-[#6ec1e4] inline-flex text-[17px]  mt-5 border-none">
                                        Electrobombas sumergibles para plantas de <br>
                                        tratamiento.
                                    </p>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:my-[230px] my-[30px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                ...
                                <section data-id="e2302cd" data-element_type="section" class="block box-border my-5 mx-0 relative w-full">
                                    <div class="box-border p-[10px] flex relative w-full flex-wrap content-start">
                                        <div data-id="7ce4ff1" data-element_type="widget" data-widget_type="image.default" class="box-border text-center relative w-full flex-nowrap">
                                            <div class="box-border transition-all duration-300">
                                                <a href="/img/curve_GM_50.jpg" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="curve_GM_50" data-elementor-lightbox-description="Rango operativo bomba sumergible GM 50" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjAyOCwidXJsIjoiaHR0cHM6XC9cL2ltZ1wvY3VydmVfR01fNTAuanBnIn0%3D" class="text-[#007bff] no-underline bg-transparent inline-block shadow-none">
                                                    <picture fetchpriority="high" decoding="async" title="Bombas sumergibles para aguas sucias - GM 50 3" class="box-border">
                                                        <source type="image/webp" sizes="(max-width: 1024px) 100vw, 1024px" srcset="/img/curve_GM_50-1024x441.jpg.webp 1024w, /img/curve_GM_50-300x129.jpg.webp 300w, /img/curve_GM_50-768x331.jpg.webp 768w, /img/curve_GM_50.jpg.webp 1143w" />
                                                        <img fetchpriority="high" width="1024" height="441" alt="Rango operativo bomba sumergible GM 50" sizes="(max-width: 1024px) 100vw, 1024px" srcset="/img/curve_GM_50-1024x441.jpg 1024w, /img/curve_GM_50-300x129.jpg 300w, /img/curve_GM_50-768x331.jpg 768w, /img/curve_GM_50.jpg 1143w" class="max-w-full h-auto align-middle border-none inline-block" />
                                                    </picture>
                                                </a>
                                            </div>
                                        </div>
