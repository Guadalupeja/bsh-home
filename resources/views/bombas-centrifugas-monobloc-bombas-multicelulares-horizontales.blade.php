    ...
    <div class="w-full md:w-3/4 flex flex-wrap px-1 py-0 mx-auto">
            ...
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-centrifugas-monobloc-con-orificios-roscados-nm-nmd') }}">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-recirculacion-y-climatizacion/bombas-centrifugas-monobloc-con-bridas-nm-nms') }}">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-recirculacion-y-climatizacion/bombas-centrifugas-monobloc-n-%e2%89%88-1450-1-min-nm4-nms4') }}">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-recirculacion-y-climatizacion/bombas-centrifugas-de-aspiracion-axial-segun-norma-europea-en-733-n-n4') }}">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-recirculacion-y-climatizacion/bombas-in-line-n-2900-1-min-n-1450-1-min-nr-nr4') }}">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-mxh') }}">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-multicelulares-verticales-monobloc-mxv-b') }}">
            ...
            <div class="mb-2 relative w-full flex flex-row justify-center">
                <div class="box-border transition-all ease-in-out">
                    <div>
                        <h2 class="text-[20px] text-[#2953b1] leading-[25px] mt-0 mb-0 clear-both font-semibold font-[Open Sans] m-0 text-left">
                            <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-multicelulares-verticales-monobloc-mxv-b') }}" class="text-[#007bff] no-underline bg-transparent">
            ...
            <div class="relative w-full text-left flex flex-row justify-center">
                <div class="box-border m-0 transition-all ease-in-out">
                    <div>
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-presurizacion/bombas-multicelulares-verticales-monobloc-mxv-b') }}" class="text-white no-underline bg-[#043e81] box-border font-roboto font-medium text-[18px] py-2.5 px-3 rounded-[5px] inline-block leading-[18px] text-center transition-all ease-in-out w-auto">
                            <span class="flex justify-center">
                                <span class="mr-1 order-5 flex-grow-0">
                                    <i class="fas fa-plus text-white py-3"></i>
                                </span>
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-recirculacion-y-climatizacion/bombas-centrifugas-con-rodete-abierto-c') }}">
        ...
        <div class="box-border p-1 md:m-0 mx-auto flex relative w-full md:w-1/3 flex-wrap content-start md:justify-start justify-center text-center">
            <div class="box-border mb-1 overflow-hidden relative w-full flex flex-row flex-nowrap justify-center">
                <div class="box-border transition-all ease-in-out group">
                    <div class="box-border block relative z-10 overflow-hidden text-center">
                        <a href="{{ url('/bombas/bombas-centrifugas-calpeda/bombas-para-obra-civil-y-urbanistica/bombas-calpeda-recirculacion-y-climatizacion/bombas-con-rodete-periferico-t-tp') }}">
