...
@section('title', 'GEO- Estación automática de recogida y elevación de aguas')
@section('description', 'GEO- Estación automática de recogida y elevación de aguas CALPEDA. Entrega Inmediata. 
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "GEO - Estación automática de recogida y elevación de aguas sucias",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
  "description": "GEO - Estación automática de recogida y elevación de aguas sucias CALPEDA. Entrega Inmediata. Marca Premium. Distribuidor Mayorista. Refacciones y Mantenimiento.",
  "sku": "CALP-GEO-001",
  "mpn": "GEO-001",
  "category": "Industrial Pumps",
  "image": [
    "/img/Estacion-automatica-de-recogida-y-elevacion-de-aguas-sucias-GEO-1.png.webp",
    "/img/Estacion-automatica-de-recogida-y-elevacion-de-aguas-sucias-GEO-2.png.webp",
    "/img/Estacion-automatica-de-recogida-y-elevacion-de-aguas-sucias-GEO-3.png.webp"
  ],
  "offers": {
    "@type": "Offer",
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/Estacion-automatica-de-recogida-y-elevacion-de-aguas-sucias-GEO-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/Estacion-automatica-de-recogida-y-elevacion-de-aguas-sucias-GEO-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 3 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/Estacion-automatica-de-recogida-y-elevacion-de-aguas-sucias-GEO-3.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                                </div>
                                            </div>
                                            <!-- Add Pagination -->
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-[#666] leading-[27px] mb-8 text-justify">
                                                        Depósito en polietileno de media densidad, resistente a la cor- rosión, de dimensiones reducidas.
GEO 40 capacidad depósito 40 litros, para la instalación de unaelectrobomba tipo GXRM.
GEO 230 capacidad depósito 230 litros, para la instalación de unaelectrobomba tipo GM 10, GX o GM.
GEO 500 capacidad depósito 500 litros, para la instalación de doselectrobombas tipo GM 10, GX o GM.
Kit tubería para la conexión de la electrobomba.Dos posibilidades de instalación, en suelo o enterrado.Para la instalación enterrada, hay disponibles 
prolongaciones para llevar la tapa a nivel del suelo.Fácil acceso a la bomba por medio de una gran tapa.
                                                    </p>
                                                    ...
                                                    <p class="text-[#666] leading-[27px] mb-8">
                                                        Estaciones de recogida y elevación automática de aguas sucias domésticas, civiles e industriales.Para la recogida y 
                                                        bombeo de aguas claras de desecho, pluviales, y achiques en ambientes sujetos a inundaciones.
                                                    </p>
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">GEO</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Estación automática de recogida y elevación de aguas sucias</div>
                                        </div>
                                    </h1>
                                </div>
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/ES%20-%20Espa%C3%B1ol/DIVISI/GEO_ES.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Download<br />50 Hz Catalogue</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="1f61649" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="dd8d718" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/GEO_60Hz2023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descarga<br />Catálogo 60 Hz</a><br>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/ISTRUZIONI/IST%20GEO_Rev1_09_2021.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descarga<br />Instrucciones</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
