...
@section('title', 'Bombas sumergibles de caña vertical - VAL SC CALPEDA - BSH')
@section('description', '
Cotiza aquí Bombas sumergibles de caña vertical VAL SC CALPEDA. Entrega Inmediata. 
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Bombas sumergibles de caña vertical - VAL SC CALPEDA",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
  "description": "Cotiza aquí Bombas sumergibles de caña vertical VAL SC CALPEDA. Entrega Inmediata. Marca Premium Italiana. Distribuidor Mayorista. Refacciones y Mantenimiento.",
  "sku": "CALP-VALSC-78910",
  "mpn": "VALSC-78910",
  "category": "Industrial Pumps",
  "image": [
    "/img/Bombas-sumergibles-de-caNa-vertical-VAL-SC-.png",
    "/img/curve_VAL-SC-1024x437.jpg",
    "/img/download-2.png"
  ],
  "offers": {
    "@type": "Offer",
  ...
  "review": [
    {
      ...
      "reviewBody": "Esta bomba sumergible ha sido una excelente inversión para nuestra planta industrial. Alta durabilidad y rendimiento."
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "Muy satisfecha con el servicio postventa y la calidad del producto. La instalación fue sencilla y el rendimiento es excelente."
    }
  ],
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://bombasellos.com.mx/bombas-sumergibles-val-sc-calpeda"
  }
}
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bombasellos.com.mx/bombas/sumergibles-calpeda/"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Bombas sumergibles de caña vertical VAL SC",
      "item": "https://bombasellos.com.mx/bombas-sumergibles-val-sc-calpeda"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué son las bombas sumergibles de caña vertical VAL SC CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las bombas sumergibles de caña vertical VAL SC CALPEDA están diseñadas para aplicaciones industriales y civiles que requieren manejo de aguas residuales o agua sucia con sólidos. Son ideales para sistemas de drenaje, extracción de agua y aplicaciones industriales."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cuál es el precio de las bombas VAL SC CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "El precio de las bombas VAL SC CALPEDA varía según el modelo y las especificaciones. Para más detalles, visita nuestro sitio web o contacta con nuestro equipo de ventas."
      }
    },
    {
      "@type": "Question",
      "name": "¿Dónde puedo comprar bombas VAL SC CALPEDA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Puedes comprar bombas VAL SC CALPEDA a través de nuestro sitio web o visitando nuestras sucursales. Ofrecemos entrega inmediata y soporte técnico especializado."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "description": "Ofrecemos distribución de bombas industriales de alta calidad para aplicaciones civiles e industriales, con soporte técnico y mantenimiento especializado."
}
</script>
@endsection
                            ...
                            <div class="w-full">
                                <div class="transition-all duration-300">
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        <img 
                                            decoding="async" 
                                            src="/img/Bombas-sumergibles-de-caNa-vertical-VAL-SC-.png" 
                                            alt="Bombas sumergibles de caña vertical VAL SC" 
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                <p class="leading-[23px] mb-[32px] mt-0 text-[#666666]">
                                                    <strong class="font-bold">Construcción</strong>
                                                </p>
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="text-[#666] leading-[27px] mb-8 text-justify">
                                                        Bombas sumergibles de un solo impulsor, (con dos canales) con impulsor de canales y puerto de descarga roscado vertical (G 2”). Doble sello mecánico en 
                                                        el eje con cámara de aceite interpuesta, para proteger contra el funcionamiento en seco.
                                                    </p>
                                                    ...
                                                    <p class="text-[#666] leading-[27px] mb-8">
                                                        Para aguas residuales domésticas o industriales, agua sucia con sólidos de hasta 50 mm de tamaño de grano.
Para líquidos que sean compatibles con los materiales de la bomba.
Para el drenaje de habitaciones o el vaciado de tanques.
Extracción de agua de estanques, arroyos o pozos, y para la recolección de agua de lluvia.
                                                    </p>
                    ...
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex flex-wrap content-start">
                        <div class="relative w-full">
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">VAL SC</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas sumergibles de caña vertical</div>
                                        </div>
                                    </h1>
                                </div>
                                ...
                                <div class="relative w-full flex flex-row flex-nowrap mb-5 text-gray-500 font-roboto font-normal">
                                    <div class="transition-all duration-300">
                                        <p class="text-[#666666] leading-[23px] mb-4 mt-8">
                                            Electrobomba da caña vertical, con motor exterior y cuerpo bomba sumergido 
                                            en el líquido a bombear (no es necesario instalar tubo de aspiración ni válvula de pie).
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none my-[50px] lg:my-[250px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                            ...
                                            <div class="box-border w-full relative flex min-h-[1px] flex-wrap content-start">
                                                <div class="box-border p-2.5 w-full flex relative flex-wrap content-start">
                                                    <div class="box-border text-center w-full flex flex-col items-center justify-center">
                                                        <div class="transition-all duration-300">
                                                                    <picture decoding="async" title="Bombas sumergibles de caña vertical - VAL SC 25" class="box-border">
                                                                    <source type="image/webp" srcset="/img/curve_VAL-SC-1024x437.jpg.webp 1024w, /img/curve_VAL-SC-300x128.jpg.webp 300w, /img/curve_VAL-SC-768x328.jpg.webp 768w, /img/curve_VAL-SC.jpg.webp 1176w" sizes="(max-width: 1024px) 100vw, 1024px" class="box-border" />
                                                                    <img decoding="async" width="1024" height="437" src="/img/curve_VAL-SC-1024x437.jpg" alt="curve VAL SC" class="max-w-full h-auto align-middle border-none box-border inline-block shadow-none" />
                                                                </picture>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="max-w-[1190px] mx-auto flex relative">
                                            <div class="box-border w-1/2 relative flex min-h-[1px] flex-wrap content-start">
                                                <div class="box-border p-2.5 w-full flex relative flex-wrap content-start">
                                                    <div class="box-border text-center w-full flex flex-col items-center justify-center">
                                                        <div class="transition-all duration-300">
                                                            <a href="https://es.calpeda.com/system/products/catalogue_50hzs/64/es/VAL_SC_SPA2019.pdf?1586965847" target="_blank" rel="noopener" class="text-blue-600 no-underline bg-transparent inline-block shadow-none">
                                                    ...
                                                    <div class="box-border text-gray-600 font-roboto font-normal text-left w-full flex flex-row flex-nowrap">
                                                        <div class="transition-all duration-300">
                                                            <p class="text-gray-600 leading-7 mb-8 mt-0">
                                                                <a href="https://calpeda.de/media/pdf/7b/d6/3d/28_VAL_60Hz2014.pdf" target="_blank" rel="noopener" class="text-blue-600 no-underline box-shadow-none">Descarga<br />Catalogo 60 Hz</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
