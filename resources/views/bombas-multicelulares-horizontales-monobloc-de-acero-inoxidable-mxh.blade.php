...
@section('title', 'Bombas multicelulares horizontales de acero inoxidable - MXH')
@section('description', 'Bombas multicelulares horizontales de acero inoxidable - MXH CALPEDA. Entrega Inmediata 
...
<!-- Schema JSON-LD para Producto -->
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Product",
  "name": "Bombas multicelulares horizontales de acero inoxidable - MXH",
  "description": "Bombas multicelulares horizontales de acero inoxidable MXH CALPEDA. Ideales para abastecimiento de agua en aplicaciones industriales y domésticas. Entrega inmediata.",
  "brand": {
    "@type": "Brand",
    "name": "Calpeda"
  },
  ...
  "image": [
    "/img/Bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-MXH-1.png.webp",
    "/img/Bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-MXH-2.png.webp"
  ],
  "offers": {
    "@type": "Offer",
    "url": "https://bombasellos.com.mx/bombas/mxh",
    "priceCurrency": "MXN",
    "price": "38000",
  ...
  "review": [
    {
      ...
      "reviewBody": "Excelente bomba para aplicaciones industriales. Duradera y eficiente."
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "Muy buena, aunque un poco difícil de instalar."
    }
  ],
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://bombasellos.com.mx/bombas/mxh"
  }
}
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Bombas multicelulares MXH",
      "item": "https://bombasellos.com.mx/bombas/mxh"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué aplicaciones tienen las bombas multicelulares MXH?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Las bombas multicelulares MXH de Calpeda son ideales para abastecimiento de agua en aplicaciones industriales, civiles y domésticas."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "La entrega es inmediata para todas las bombas multicelulares MXH disponibles en stock."
      }
    }
  ]
}
...
<!-- Schema JSON-LD para Servicio -->
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Service",
  "serviceType": "Venta de bombas industriales",
  "provider": {
    "@type": "Organization",
    "name": "BSH (Bombas Sellos y Hules Industriales S.A. de C.V.)"
  },
  "description": "Venta y mantenimiento de bombas multicelulares horizontales MXH de acero inoxidable. Servicio de asesoría técnica y soporte en la instalación y mantenimiento."
}
</script>
@endsection
...
@section('contenido')
<h2 class="text-[19px] p-2.5 text-black leading-[19px] lg:mt-[100px] lg:ml-[120.5px] mt-4 mb-4 clear-both font-semibold font-roboto box-border">
    ELECTROBOMBAS CENTRIFUGAS DE UN SOLO RODETE Y DE DOS RODETES
  </h2>
<!-- Contenido e imágenes -->
<div class="lg:mt-[40px] box-border p-2.5 flex flex-col relative w-full content-start mx-auto lg:w-[90%] lg:flex-row lg:ml-[120.5px]">
                ...
                <div class="max-w-[1190px] mx-auto flex flex-col lg:flex-row">
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="/img/Bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-MXH-1.png.webp" alt="Slide 1" class="w-full h-auto object-cover">
                                                </div>
                                                <!-- Slide 2 -->
                                                <div class="swiper-slide">
                                                    <img src="/img/Bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-MXH-2.png.webp" alt="Slide 2" class="w-full h-auto object-cover">
                                                </div>
                                            
                                                    <!-- Slide 3 -->
                                                    <div class="swiper-slide">
                                                        <img src="/img/Bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-MXH-3.png.webp" alt="Slide 3" class="w-full h-auto object-cover">
                                                    </div>
                                                    <!-- Slide 4 -->
                                                    <div class="swiper-slide">
                                                        <img src="/img/Bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-MXH-4.png.webp" alt="Slide 4" class="w-full h-auto object-cover">
                                                    </div>
                                                
                                                        <!-- Slide 5 -->
                                                        <div class="swiper-slide">
                                                            <img src="/img/Bombas-multicelulares-horizontales-monobloc-de-acero-inoxidable-MXH-5.png.webp" alt="Slide 5" class="w-full h-auto object-cover">
                                                        </div>
                                            </div>
                                            <!-- Add Pagination -->
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    <p class="leading-[23px] mb-8 mt-0 text-[#666]"><strong class="font-bold">Ejecución</strong></p>
                                                    <p class="leading-[23px] mb-8 mt-0 text-[#666]">Bombas multicelulares horizontales monobloc de acero inoxidable al cromo-níquel. Construcción compacta y robusta, sin brida sobresaliente y acoplamiento bomba motor único con pie soporte. Cuerpo bomba en una sola pieza, abierto por un solo lado (barril casing), con boca de aspiración frontal sobre el eje de la bomba y boca de impulsión radial en la parte superior. Tapones de cebado y vaciado en posiciones medias, accesibles desde cada lado (como la tapa de bornes).</p>
                                                    <p class="leading-[23px] mb-8 mt-0 text-[#666]"><strong class="font-bold">Aplicaciones</strong></p>
                                                    <p class="leading-[23px] mb-8 mt-0 text-[#666]">– Para aprovisionamiento de agua. - Para líquidos limpios, sin partes abrasivas, no agresivos para el acero inoxidable (con adaptación, bajo demanda, de los materiales del sello mecánico). - Bomba universal, para uso doméstico, para aplicaciones civiles e industriales, para jardinería e irrigación.</p>
                                                 </div>

                                                 <div data-id="030d56e" class="box-border mb-5 relative w-full flex flex-nowrap">
                                                    <div class="box-border overflow-hidden transition-all duration-300 ease-in-out transform">
                                                        <div class="aspect-w-16 aspect-h-9">
                                                            <iframe width="560" height="315" src="https://www.youtube.com/embed/POmAG9daJeg?si=I6eiX2XMJex7m0Sg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div data-id="6abdc77" class="box-border mb-5 relative w-full flex flex-nowrap">
                                                    <div class="box-border overflow-hidden transition-all duration-300 ease-in-out transform">
                                                        <div class="aspect-w-16 aspect-h-9">
                                                            <iframe width="560" height="315" src="https://www.youtube.com/embed/Svc5iiRT0QE?si=kSxlBOzILDluQF2n" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="w-full lg:w-1/2 box-border p-2.5 flex flex-wrap content-start">
                        <div class="relative w-full">
                                ...
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h2 class="text-2xl text-blue-700 leading-6 mt-0 mb-0 font-semibold font-open-sans text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">MXH</div>
                                        </div>
                                    </h2>
                                </div>
                            </div>
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas multicelulares horizontales monobloc de acero inoxidable.
                                            </div>
                                        </div>
                                    </h1>
                                    <p class="leading-[23px] mb-8 mt-2 text-[#666]">
                                        Bombas multicelulares horizontales monobloc de acero inoxidable al cromo-níquel. Construcción compacta y robusta, sin brida sobresaliente y acoplamiento bomba motor único con pie soporte.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none lg:mt-[180px] mx-0 p-2.5 flex w-full flex-wrap content-start">
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    <div data-id="7ce4ff1" data-element_type="widget" data-widget_type="image.default" class="box-border text-center w-full flex-row flex-nowrap relative">
                                        <div class="transition-all duration-300">
                                                <img fetchpriority="high" width="1024" height="593" alt="NM4 NMS4 curve" sizes="(max-width: 1024px) 100vw, 1024px" title="Bombas multicelulares horizontales monobloc de acero inoxidable - MXH 46" nitro-lazy-srcset="/img/NM4_NMS4_curve-1024x593.png 1024w, /img/NM4_NMS4_curve-1024x593.png 300w, /img/NM4_NMS4_curve-1024x593.png 768w, /img/NM4_NMS4_curve-1536x889.png 1536w, /img/NM4_NMS4_curve.png 1876w" nitro-lazy-src="/img/NM4_NMS4_curve-1024x593.png" decoding="async" nitro-lazy-empty="" src="/img/NM4_NMS4_curve-1024x593.png" srcset="/img/NM4_NMS4_curve-1024x593.png 1024w, /img/NM4_NMS4_curve-300x174.png 300w, /img/NM4_NMS4_curve-768x445.png 768w, /img/NM4_NMS4_curve-1536x889.png 1536w, /img/NM4_NMS4_curve.png 1876w" class="max-w-full h-auto align-middle border-none box-border inline-block border-0 rounded-none shadow-none" />
                            ...
                            <div class="box-border transition-all duration-300 bg-transparent border-none border-radius-none shadow-none mt-[130px]  lg:mt-[80px] mx-0 p-2.5 flex relative w-full flex-wrap content-start">
                                                ...
                                                <div data-id="24ffc14" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/ES%20-%20Espa%C3%B1ol/DIVISI/MXH_ES.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar<br />Catálogo 50 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/CATALOGHI_PDF/60Hz%20-%20English_Espa%C3%B1ol/singoli_60Hz/MXH_60Hz2023.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">Descargar
                                                                Catálogo<br/>60 Hz</a>
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div data-id="87b0451" class="w-1/2 box-border relative flex">
                                            <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                                <div data-id="e59afe9" class="box-border text-[#7a7a7a] font-roboto font-normal relative w-full flex flex-row flex-nowrap">
                                                    <div class="box-border transition duration-300 ease-in-out transform">
                                                        <p class="leading-[23px] mb-[32px] mt-0 text-[#666]">
                                                            <a href="https://www.calpeda.com/wp-content/uploads/calpeda_prodotti/ISTRUZIONI/IST%20MXH%20Rev25_05_2021.pdf" target="_blank" rel="noopener" data-type="pdf" class="text-[#007bff] no-underline box-shadow-none">
