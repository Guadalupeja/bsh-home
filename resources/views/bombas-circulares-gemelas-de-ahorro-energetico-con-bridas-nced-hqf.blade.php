...
@section('title', 'Bombas circulares gemelas de ahorro energético - NCED HQF.')
...
<script type="application/ld+json">
{
  ...
  "category": "Pumps",
  "image": [
    "/img/Bombas-circulares-gemelas-de-ahorro-energetico-con-bridas-NCED-HQF.png.webp"
  ],
  "offers": {
    "@type": "Offer",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Puedes adquirir la bomba NCE HQF contactando a nuestras sucursales en México para obtener el mejor precio y soporte especializado."
      }
    }
  ]
}
                                    ...
                                    <div dir="ltr" class="pb-7.5 mx-auto relative overflow-hidden z-1">
                                        <div class="swiper-container">
                                           <figure class="m-0 block leading-[27px]">
                                                <picture decoding="async" title="Bombas circulares gemelas de ahorro energético con bridas - NCED HQF 17">
                                                    <source type="image/webp" srcset="/img/Bombas-circulares-gemelas-de-ahorro-energetico-con-bridas-NCED-HQF.png.webp" />
                                                    <img decoding="async" src="/img/Bombas-circulares-gemelas-de-ahorro-energetico-con-bridas-NCED-HQF.png.webp" alt="Bombas-circulares-gemelas-de-ahorro-energetico-con-bridas---NCED-HQF" class="max-w-full h-auto align-middle border-none" />
                                                </picture>
                                            </figure>
                                        </div>
                                        ...
                                        <div class="box-border p-2.5 flex flex-wrap w-full align-start text-justify mt-[80px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="transition-all duration-300 ease-in-out text-[#7a7a7a] font-roboto font-normal">
                                                    ...
                                                    <p class="text-[#666] leading-[27px] mb-8 mt-0">
                                                        Sistemas de calefacción y acondicionamiento.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="mb-5 w-full flex flex-col">
                                <div class="transition-all duration-300 ease-in-out">
                                    ...
                                    <h1 class="text-4xl leading-10 mt-0 mb-0 font-semibold font-open-sans text-gray-600 text-left">
                                        <div class="inline-block relative">
                                            <div class="font-roboto font-semibold text-blue-800 border-cyan-400 inline-flex text-lg">Bombas circulares gemelas de ahorro energético con bridas
                                            </div>
                                        </div>
                                    </h1>
                                </div>
                                ...
                                <div class="box-border p-2.5 flex relative w-full flex-wrap content-start">
                                    ...
                                    <div class="relative w-full flex justify-center">
                                        <div class="transition-all duration-300 ease-in-out transform">
                                                ...
                                                <img fetchpriority="high" decoding="async" width="1024" height="854" src="/img/NCED_HQF_curve-1024x675.png" alt="NCE HQF curve" srcset="/img/NCED_HQF_curve-1024x675.png 1024w, /img/NCED_HQF_curve-1024x675.png 300w, /img/NCED_HQF_curve-1024x675.png 768w, /img/NCED_HQF_curve-1024x675.png 1097w" sizes="(max-width: 1024px) 100vw, 1024px" title="Bombas circuladoras de bajo consumo - NCED HQF" class="max-w-full h-auto align-middle border-none inline-block" />
